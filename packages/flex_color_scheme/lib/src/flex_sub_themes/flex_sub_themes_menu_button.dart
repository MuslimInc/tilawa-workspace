...
MenuButtonThemeData _menuButtonTheme({
  ...
  final Color foregroundColor = FlexSubThemes.schemeColor(
    fgScheme,
    colorScheme,
  );
  ...
  final Color indicatorBgColor = FlexSubThemes.schemeColor(
    indBgScheme,
    colorScheme,
  );
  ...
  final Color indicatorFgColor = FlexSubThemes.schemeColor(
    indFgScheme,
    colorScheme,
  );
