...
class FlexSubThemesData with Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    //
    properties.add(
      DiagnosticsProperty<FlexAdaptive>(
        'adaptiveRemoveElevationTint',
        adaptiveRemoveElevationTint,
      ),
    );
    ...
    properties.add(
      DiagnosticsProperty<bool>('alignedDropdown', alignedDropdown),
    );
    properties.add(
    ...
    //
    properties.add(
      EnumProperty<FlexScaffoldBaseColor>(
        'scaffoldBackgroundBaseColor',
        scaffoldBackgroundBaseColor,
      ),
    );
    ...
    properties.add(
      DiagnosticsProperty<bool>('switchThumbFixedSize', switchThumbFixedSize),
    );
    properties.add(
      DiagnosticsProperty<FlexAdaptive>(
        'switchAdaptiveCupertinoLike',
    ...
    properties.add(
      EnumProperty<FlexSliderIndicatorType>(
        'sliderValueIndicatorType',
        sliderValueIndicatorType,
      ),
    );
    ...
    properties.add(
      DiagnosticsProperty<bool>('inputDecoratorIsDense', inputDecoratorIsDense),
    );
    properties.add(
      DiagnosticsProperty<bool>(
        'inputDecoratorIsFilled',
    ...
    properties.add(
      EnumProperty<FlexInputBorderType>(
        'inputDecoratorBorderType',
        inputDecoratorBorderType,
      ),
    );
    ...
    properties.add(
      EnumProperty<ListTileTitleAlignment>(
        'listTileTitleAlignment',
        listTileTitleAlignment,
      ),
    );
    properties.add(
      EnumProperty<ListTileControlAffinity>(
        'listTileControlAffinity',
        listTileControlAffinity,
      ),
    );
    ...
    properties.add(
      DiagnosticsProperty<bool>('chipBlendColors', chipBlendColors),
    );
    properties.add(
    ...
    properties.add(
      DiagnosticsProperty<TextStyle>('chipLabelStyle', chipLabelStyle),
    );
    properties.add(
      DiagnosticsProperty<TextStyle>(
        'chipSecondaryLabelStyle',
    ...
    properties.add(
      EnumProperty<SchemeColor>('cardBorderSchemeColor', cardBorderSchemeColor),
    );
    properties.add(
    ...
    properties.add(
      DiagnosticsProperty<double>('searchViewElevation', searchViewElevation),
    );
    properties.add(
      DiagnosticsProperty<double>('searchBarRadius', searchBarRadius),
    );
    properties.add(
      DiagnosticsProperty<double>('searchViewRadius', searchViewRadius),
    );
    properties.add(
      DiagnosticsProperty<bool>('searchUseShape', searchUseGlobalShape),
    );
    properties.add(
      DiagnosticsProperty<double>(
        'searchViewHeaderHeight',
    ...
    properties.add(
      ColorProperty('searchViewDividerColor', searchViewDividerColor),
    );
    ...
    properties.add(
      DiagnosticsProperty<double>('dialogRadiusAdaptive', dialogRadiusAdaptive),
    );
    properties.add(
    ...
    properties.add(
      DiagnosticsProperty<TextStyle>('datePickerDayStyle', datePickerDayStyle),
    );
    properties.add(
      DiagnosticsProperty<TextStyle>(
        'datePickerYearStyle',
    ...
    properties.add(
      EnumProperty<SchemeColor>('appBarIconSchemeColor', appBarIconSchemeColor),
    );
    properties.add(
      EnumProperty<SchemeColor>(
        'appBarActionsIconSchemeColor',
    ...
    properties.add(
      EnumProperty<TabBarIndicatorSize>(
        'tabBarIndicatorSize',
        tabBarIndicatorSize,
      ),
    );
    ...
    properties.add(
      EnumProperty<TabIndicatorAnimation>(
        'tabBarIndicatorAnimation',
        tabBarIndicatorAnimation,
      ),
    );
    ...
    properties.add(
      EnumProperty<BottomNavigationBarType>(
        'bottomNavigationBarType',
        bottomNavigationBarType,
      ),
    );
