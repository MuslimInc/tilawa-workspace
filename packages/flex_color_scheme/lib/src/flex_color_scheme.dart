...
class FlexColorScheme with Diagnosticable {
  ...
  const FlexColorScheme({
    ...
    this.onBackground,
         ...
         appBarElevation == null || appBarElevation >= 0.0,
  ...
  factory FlexColorScheme.light({
    ...
    assert(
      appBarOpacity == null || appBarOpacity >= 0 && appBarOpacity <= 1,
    ...
    final FlexSchemeSurfaceColors
    surfaceSchemeColors = FlexSchemeSurfaceColors.blend(
      brightness: Brightness.light,
    ...
    final Color effectiveSurfaceColor = lightIsWhite
        ? inputSurface.lighten(5)
        : inputSurface;
    ...
    final ColorScheme effectiveColorScheme =
        ...
        ColorScheme(
          ...
          primaryFixed:
              schemeForFixedColors?.primaryFixed ??
              _fixedColor(effectivePrimaryLightRef),
          primaryFixedDim:
              schemeForFixedColors?.primaryFixedDim ??
              _fixedDimColor(effectivePrimaryLightRef),
          onPrimaryFixed:
              schemeForFixedColors?.onPrimaryFixed ??
              _onFixedColor(effectivePrimaryLightRef),
          onPrimaryFixedVariant:
              schemeForFixedColors?.onPrimaryFixedVariant ??
          ...
          secondaryFixed:
              schemeForFixedColors?.secondaryFixed ??
              _fixedColor(effectiveSecondaryLightRef),
          secondaryFixedDim:
              schemeForFixedColors?.secondaryFixedDim ??
              _fixedDimColor(effectiveSecondaryLightRef),
          onSecondaryFixed:
              schemeForFixedColors?.onSecondaryFixed ??
          ...
          tertiaryFixed:
              schemeForFixedColors?.tertiaryFixed ??
              _fixedColor(effectiveTertiaryLightRef),
          tertiaryFixedDim:
              schemeForFixedColors?.tertiaryFixedDim ??
              _fixedDimColor(effectiveTertiaryLightRef),
          onTertiaryFixed:
              schemeForFixedColors?.onTertiaryFixed ??
    ...
    effectiveAppBarColor ??=
        ...
        ? FlexSubThemes.schemeColor(
            subTheme.appBarBackgroundSchemeColor!,
            effectiveColorScheme,
          )
        : null;
    ...
    if (appBarOpacity != null) {
      effectiveAppBarColor = effectiveAppBarColor.withValues(
        alpha: appBarOpacity,
      );
    }
  ...
  factory FlexColorScheme.dark({
    ...
    final Color effectiveSurfaceColor = darkIsTrueBlack
        ? inputSurface.darken(5)
        : inputSurface;
  ...
  static SystemUiOverlayStyle themedSystemNavigationBar(
    ...
    final Color flexBackground = (context != null)
        ? switch (systemNavBarStyle) {
            ...
            FlexSystemNavBarStyle.background => Theme.of(
              context,
            ).colorScheme.surfaceContainerLow,
            FlexSystemNavBarStyle.surface => Theme.of(
              context,
            ).colorScheme.surface,
            FlexSystemNavBarStyle.scaffoldBackground => Theme.of(
              context,
            ).scaffoldBackgroundColor,
            FlexSystemNavBarStyle.transparent => Theme.of(
              context,
            ).scaffoldBackgroundColor,
    ...
    if (useDivider == null || !useDivider) {
      ...
      if (systemNavigationBarDividerColor == null) {
        ...
        dividerColor = systemNavigationBarDividerColor.withValues(
    ...
    final Brightness? statusBarBrightness = noAppBar
    ...
    final Brightness? statusBarIconBrightness = noAppBar
        ...
        ? appBarBrightness
        : null;
    final Color sysNavigationBarColor = background.withValues(
      alpha: usedOpacity,
    );
    final Color sysNavigationBarDividerColor = invertStatusIcons
        ? Colors.transparent
        : dividerColor;
  ...
  ThemeData get toTheme {
    ...
    TextTheme defText = isDark
        ? effectiveTypography.white
        : effectiveTypography.black;
    final bool primaryIsDark = isColorDark(colorScheme.primary);
    TextTheme defPrimaryText = primaryIsDark
        ? effectiveTypography.white
        : effectiveTypography.black;
    ...
    if (fontFamilyFallback != null) {
      ...
      defPrimaryText = defPrimaryText.apply(
        fontFamilyFallback: fontFamilyFallback,
      );
    }
    if (package != null) {
    ...
    Color appBarForegroundColor() {
      if (useSubThemes && subTheme.appBarForegroundSchemeColor != null) {
        return FlexSubThemes.schemeColor(
          subTheme.appBarForegroundSchemeColor!,
          colorScheme,
        );
    ...
    Color appBarActionIconColor = useMaterial3
    ...
    final SystemUiOverlayStyle systemOverlayStyle = SystemUiOverlayStyle(
      ...
      statusBarIconBrightness: appBarNeedsLight
          ? Brightness.light
          : Brightness.dark,
    ...
    final Color sliderValueStyleOnColor = onColor(
      sliderValueIndicator.withAlpha(0xFF),
    );
    final TextStyle? sliderValueStyle =
        ...
        ? effectiveTextTheme.labelMedium!.copyWith(
            color: sliderValueStyleOnColor,
          )
        : null;
    ...
    final double defaultDecoratorRadius = useMaterial3
    ...
    final double? platformInputDecoratorRadius =
        adaptiveInputDecoratorRadius == const FlexAdaptive.off() &&
    ...
    final InputDecorationThemeData? effectiveInputDecorationTheme = useSubThemes
        ...
        ? FlexSubThemes.inputDecorationTheme(
            ...
            focusedBorderWidth:
                subTheme.inputDecoratorFocusedBorderWidth ??
    ...
    final Color bottomSheetColor = subTheme.bottomSheetBackgroundColor != null
        ? FlexSubThemes.schemeColor(
            subTheme.bottomSheetBackgroundColor!,
            colorScheme,
          )
        : colorScheme.surfaceContainerLow;
    final Color bottomSheetModalColor =
        ...
        ? FlexSubThemes.schemeColor(
            subTheme.bottomSheetModalBackgroundColor!,
            colorScheme,
          )
        : colorScheme.surfaceContainerLow;
    final double bottomSheetElevation =
        subTheme.bottomSheetElevation ??
    ...
    final Color? popupMenuBackgroundColor = subTheme.popupMenuOpacity == null
        ...
        ? useMaterial3
              ? colorScheme.surfaceContainer.withValues(
                  alpha: subTheme.popupMenuOpacity,
                )
    ...
    return ThemeData(
      ...
      bottomNavigationBarTheme: useSubThemes
          ? FlexSubThemes.bottomNavigationBarTheme(
              colorScheme: colorScheme,
              labelTextStyle:
                  subTheme.bottomNavigationBarLabelTextStyle ??
                  effectiveTextTheme.bodyMedium,
      ...
      chipTheme: useSubThemes
          ? FlexSubThemes.chipTheme(
              ...
              secondaryLabelStyle:
                  subTheme.chipSecondaryLabelStyle ??
      ...
      datePickerTheme: useSubThemes
          ? FlexSubThemes.datePickerTheme(
              ...
              radius:
                  subTheme.datePickerDialogRadius ??
      ...
      dropdownMenuTheme: useSubThemes
          ? FlexSubThemes.dropdownMenuTheme(
              colorScheme: colorScheme,
              textStyle:
                  subTheme.dropdownMenuTextStyle ??
                  effectiveTextTheme.bodyLarge,
      ...
      menuBarTheme: useSubThemes
          ? FlexSubThemes.menuBarTheme(
              colorScheme: colorScheme,
              backgroundSchemeColor:
                  subTheme.menuBarBackgroundSchemeColor ??
      ...
      navigationBarTheme: useSubThemes
          ? FlexSubThemes.navigationBarTheme(
              colorScheme: colorScheme,
              labelTextStyle:
                  subTheme.navigationBarLabelTextStyle ??
      ...
      navigationRailTheme: useSubThemes
          ? FlexSubThemes.navigationRailTheme(
              colorScheme: colorScheme,
              labelTextStyle:
                  subTheme.navigationRailLabelTextStyle ??
                  effectiveTextTheme.labelMedium,
      ...
      outlinedButtonTheme: useSubThemes
          ? FlexSubThemes.outlinedButtonTheme(
              ...
              pressedOutlineWidth:
                  subTheme.outlinedButtonPressedBorderWidth ??
                  subTheme.thickBorderWidth,
              outlineWidth:
                  subTheme.outlinedButtonBorderWidth ??
      ...
      segmentedButtonTheme: useSubThemes
          ? FlexSubThemes.segmentedButtonTheme(
              ...
              borderWidth:
                  subTheme.segmentedButtonBorderWidth ??
                  subTheme.thinBorderWidth,
      ...
      tabBarTheme: FlexSubThemes.tabBarTheme(
        ...
        indicatorColor: subTheme.tabBarIndicatorSchemeColor == null
            ? tabBarStyleColor()
            : FlexSubThemes.schemeColor(
                subTheme.tabBarIndicatorSchemeColor!,
                colorScheme,
              ),
        labelStyle: effectiveTextTheme.bodyLarge,
      ...
      textSelectionTheme: useSubThemes
          ? FlexSubThemes.textSelectionTheme(
              colorScheme: colorScheme,
              cursorSchemeColor:
                  subTheme.inputCursorSchemeColor ??
                  subTheme.inputDecoratorSchemeColor,
              selectionSchemeColor:
                  subTheme.inputSelectionSchemeColor ??
                  subTheme.inputDecoratorSchemeColor,
              selectionOpacity:
                  subTheme.inputSelectionOpacity ??
                  (isDark
      ...
      timePickerTheme: useSubThemes
          ? FlexSubThemes.timePickerTheme(
              ...
              elevation: subTheme.dialogElevation,
              radius:
                  subTheme.timePickerDialogRadius ??
                  platformDialogRadius ??
                  platformRadius,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      DiagnosticsProperty<double>('appBarElevation', appBarElevation),
    );
    properties.add(
    ...
    properties.add(
      DiagnosticsProperty<bool>('transparentStatusBar', transparentStatusBar),
    );
    properties.add(
