...
class FlexSchemeOnColors with Diagnosticable {
  ...
  factory FlexSchemeOnColors.from({
        ...
        (primaryContainer == null
            ...
            : (ThemeData.estimateBrightnessForColor(primaryContainer) ==
                  ...
                  ? Colors.white.blendAlpha(
                      primaryContainer.brighten(22),
                      primaryContainerAlpha,
                    )
                  : Colors.black.blendAlpha(
                      primaryContainer.brighten(8),
                      primaryContainerAlpha,
                    )));
    ...
    final Color? usedOnSecondaryContainer =
        ...
        (secondaryContainer == null
            ...
            : (ThemeData.estimateBrightnessForColor(secondaryContainer) ==
                      Brightness.dark
                  ? Colors.white.blendAlpha(
                      secondaryContainer.brighten(22),
                      secondaryContainerAlpha,
                    )
                  : Colors.black.blendAlpha(
                      secondaryContainer.brighten(8),
                      secondaryContainerAlpha,
                    )));
    ...
    final Color? usedOnTertiaryContainer =
        ...
        (tertiaryContainer == null
            ...
            : (ThemeData.estimateBrightnessForColor(tertiaryContainer) ==
                      Brightness.dark
                  ? Colors.white.blendAlpha(
                      tertiaryContainer.brighten(22),
                      tertiaryContainerAlpha,
                    )
                  : Colors.black.blendAlpha(
                      tertiaryContainer.brighten(8),
                      tertiaryContainerAlpha,
                    )));
    ...
    final Color usedOnSurface =
        ...
        (ThemeData.estimateBrightnessForColor(surface) == Brightness.dark
            ? useM3
                  ? FlexColor.darkFlexOnSurface.blendAlpha(
                      usedSurfaceTint.darken(10),
                      surfaceAlpha,
                    )
                  : Colors.white.blendAlpha(
                      usedSurfaceTint.darken(10),
            ...
            : useM3
            ? FlexColor.lightFlexOnSurface.blendAlpha(
                usedSurfaceTint.lighten(24),
                surfaceAlpha,
              )
            : Colors.black.blendAlpha(
                usedSurfaceTint.lighten(24),
    ...
    final Color usedOnSurfaceVariant =
        ...
        (ThemeData.estimateBrightnessForColor(surface) == Brightness.dark
            ? useM3
                  ? FlexColor.darkFlexOnSurfaceVariant.blendAlpha(
                      usedSurfaceTint.darken(10),
                      surfaceAlpha,
                    )
                  : Colors.white.blendAlpha(
            ...
            : useM3
            ? FlexColor.lightFlexOnSurfaceVariant.blendAlpha(
                usedSurfaceTint.lighten(24),
                surfaceAlpha,
              )
            : Colors.black.blendAlpha(
    ...
    final Color usedOnInverseSurface =
        ...
        (ThemeData.estimateBrightnessForColor(invSurface) == Brightness.dark
            ? useM3
                  ...
                  : FlexColor.materialLightSurface.blendAlpha(
                      invSurface,
                      inverseSurfaceAlpha,
                    )
            : useM3
            ? FlexColor.darkFlexOnInverseSurface.blendAlpha(
                usedSurfaceTint.darken(10),
                inverseSurfaceAlpha,
              )
            : FlexColor.materialDarkSurface.blendAlpha(
                invSurface,
                inverseSurfaceAlpha,
              ));
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      ColorProperty('onSurfaceContainerLow', onSurfaceContainerLow),
    );
    properties.add(ColorProperty('onSurfaceContainer', onSurfaceContainer));
    properties.add(
      ColorProperty('onSurfaceContainerHigh', onSurfaceContainerHigh),
    );
    properties.add(
