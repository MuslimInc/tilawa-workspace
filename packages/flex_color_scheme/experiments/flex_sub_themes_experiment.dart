...
abstract final class FlexSubThemes {
  ...
  static BottomAppBarThemeData bottomAppBarTheme({
    ...
    final Color? effectiveColor = backgroundSchemeColor == null && useM3
        ? null
        : backgroundColor;
            ...
            style: ButtonStyle(
              ...
              overlayColor: tintInteract
                  ? WidgetStateProperty<Color>.fromMap(<
                      ...
                      Color
                    >{
                      WidgetState.selected & WidgetState.pressed: tintedPressed(
                        overlay,
                        tint,
                        factor,
                      ),
                      WidgetState.selected & WidgetState.hovered: tintedHovered(
                        overlay,
                        tint,
                        factor,
                      ),
                      WidgetState.selected & WidgetState.focused: tintedFocused(
                        overlay,
                        tint,
                        factor,
                      ),
  ...
  static InputDecorationThemeData inputDecorationTheme({
    ...
    final Color unfocusedIconDefaultM2 = isDark
        ? Colors.white70
        : Colors.black45;
    ...
    return InputDecorationThemeData(
      ...
      iconColor: WidgetStateColor.fromMap(<WidgetStatesConstraint, Color>{
        ...
        WidgetState.any: useM3
            ? colorScheme.onSurfaceVariant
            : unfocusedIconDefaultM2,
      }),
  ...
  static MenuButtonThemeData menuButtonTheme({
    ...
    final Color disabledTint = fgIsPlain
        ? colorScheme.primary
        : foregroundColor;
  ...
  static NavigationBarThemeData navigationBarTheme({
    ...
    return NavigationBarThemeData(
      ...
      labelTextStyle: WidgetStateProperty<TextStyle>.fromMap(
        <WidgetStatesConstraint, TextStyle>{
          WidgetState.selected: textStyle.copyWith(
            fontSize: labelSize,
            color: labelColor,
          ),
  ...
  static PopupMenuThemeData popupMenuTheme({
    ...
    final TextStyle? effectiveTextStyle = inputsNull
        ? null
  ...
  static SegmentedButtonThemeData segmentedButtonTheme({
    ...
    return SegmentedButtonThemeData(
      style: ButtonStyle(
        ...
        backgroundColor: WidgetStateProperty<Color?>.fromMap(
          <WidgetStatesConstraint, Color?>{
            WidgetState.disabled: unselectedSchemeColor == null
                ? null
                : unselectedColor,
            WidgetState.selected: selectedColor,
            WidgetState.any: unselectedSchemeColor == null
                ? null
                : unselectedColor,
          },
        ),
  ...
  static SnackBarThemeData snackBarTheme({
    ...
    return SnackBarThemeData(
      ...
      actionTextColor: WidgetStateColor.fromMap(<WidgetStatesConstraint, Color>{
        WidgetState.any:
    ...
    // Material-3 mode theming.
      ...
      if (useCupertinoStyle ?? false) {
        return SwitchThemeData(
          ...
          trackColor: WidgetStateProperty<Color>.fromMap(
            <WidgetStatesConstraint, Color>{
              WidgetState.disabled & WidgetState.selected: baseColor.withValues(
                alpha: 0.5,
              ),
              WidgetState.disabled: isLight
  ...
  static TabBarThemeData tabBarTheme({
    ...
    return TabBarThemeData(
      ...
      overlayColor: useCustomOverlay
          ? WidgetStateProperty<Color?>.fromMap(
              <WidgetStatesConstraint, Color?>{
                WidgetState.selected & WidgetState.hovered: overlayBase
                    .withAlpha(kAlphaHovered),
                WidgetState.selected & WidgetState.focused: overlayBase
                    .withAlpha(kAlphaFocused),
                WidgetState.selected & WidgetState.pressed: overlayBase
                    .withAlpha(kAlphaPressed),
                WidgetState.selected: null,
                WidgetState.hovered: tintInteract
  ...
  static TimePickerThemeData timePickerTheme({
    ...
    Color defaultHourMinuteColor() {
      ...
      return WidgetStateColor.fromMap(<WidgetStatesConstraint, Color>{
  ...
  static ToggleButtonsThemeData toggleButtonsTheme({
    ...
    final SchemeColor borderDefault = useM3
        ? SchemeColor.outline
        : selectedBackgroundSchemeColor;
    final Color borderColor = schemeColor(
