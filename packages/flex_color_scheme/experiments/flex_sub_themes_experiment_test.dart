...
void main() {
          ...
          CheckboxThemeData(
            side: WidgetStateBorderSide.fromMap(
              <WidgetStatesConstraint, BorderSide?>{
                WidgetState.disabled & WidgetState.selected: const BorderSide(
                  width: 2.0,
            ...
            overlayColor: WidgetStateProperty<Color>.fromMap(
              <WidgetStatesConstraint, Color>{
                WidgetState.selected & WidgetState.pressed: colorScheme
                    .onSurface
                    .withAlpha(kAlphaPressed),
                WidgetState.selected & WidgetState.hovered: colorScheme.tertiary
                    .withAlpha(kAlphaHovered),
                WidgetState.selected & WidgetState.focused: colorScheme.tertiary
                    .withAlpha(kAlphaFocused),
                WidgetState.pressed: colorScheme.tertiary.withAlpha(
                  kAlphaPressed,
                ),
                WidgetState.hovered: colorScheme.onSurface.withAlpha(
                  kAlphaHovered,
          ...
          DatePickerThemeData(
            ...
            inputDecorationTheme: InputDecorationTheme(
              ...
              >{
                ...
                WidgetState.error & WidgetState.hovered: TextStyle(
          ...
          ElevatedButtonThemeData(
            style:
                ElevatedButton.styleFrom(
                  ...
                  overlayColor: WidgetStateProperty<Color>.fromMap(
                    <WidgetStatesConstraint, Color>{
                      WidgetState.hovered: colorScheme.onSecondary.withAlpha(
                        0x0D,
                      ),
                      WidgetState.focused: colorScheme.onSecondary.withAlpha(
                        0x26,
                      ),
                      WidgetState.pressed: colorScheme.onSecondary.withAlpha(
                        0x33,
                      ),
                      WidgetState.any: Colors.transparent,
                    },
        ...
        equalsIgnoringHashCodes(
          ElevatedButtonThemeData(
            style: ButtonStyle(
              foregroundColor: WidgetStateProperty<Color?>.fromMap(
                <WidgetStatesConstraint, Color?>{
                  WidgetState.disabled: colorScheme.onSurface.withValues(
                    alpha: 0.38,
                  ),
                  WidgetState.any: colorScheme.tertiary,
                },
              ...
              overlayColor: WidgetStateProperty<Color?>.fromMap(
                <WidgetStatesConstraint, Color?>{
                  WidgetState.hovered: colorScheme.tertiary.withValues(
                    alpha: 0.08,
                  ),
                  WidgetState.focused: colorScheme.tertiary.withValues(
                    alpha: 0.12,
                  ),
                  WidgetState.pressed: colorScheme.tertiary.withValues(
                    alpha: 0.12,
                  ),
  ...
  group('WITH: FlexSubThemes.inputDecorationTheme ', () {
    ...
    test('InputDecoration FST16.1-M2 light: GIVEN a M2 '
      ...
      expect(
        ...
        equals(
          TextStyle(color: Colors.black.withValues(alpha: kTintHoverFloat)),
        ),
      );
      ...
      expect(iconColor.resolve(<WidgetState>{}), equals(Colors.black45));
    });
    ...
    test('InputDecoration FST16.2 light: GIVEN a M2 '
      ...
      expect(prefixIconColor.resolve(<WidgetState>{}), equals(Colors.black45));
      ...
      expect(suffixIconColor.resolve(<WidgetState>{}), equals(Colors.black45));
    ...
    test('InputDecoration FST16.3 dark: GIVEN a M2 '
      ...
      expect(iconColor.resolve(<WidgetState>{}), equals(Colors.white70));
      ...
      expect(prefixIconColor.resolve(<WidgetState>{}), equals(Colors.white70));
      ...
      expect(suffixIconColor.resolve(<WidgetState>{}), equals(Colors.white70));
        ...
        equalsIgnoringHashCodes(
          NavigationBarThemeData(
            ...
            iconTheme: WidgetStateProperty<IconThemeData>.fromMap(
              widgetStateMap<IconThemeData>((Set<WidgetState> states) {
      ...
      expect(
        ...
        equalsIgnoringHashCodes(
          NavigationBarThemeData(
            ...
            labelTextStyle: WidgetStateProperty<TextStyle>.fromMap(
              widgetStateMap<TextStyle>((Set<WidgetState> states) {
                if (states.contains(WidgetState.selected)) {
          ...
          OutlinedButtonThemeData(
            style: ButtonStyle(
              ...
              side: WidgetStateProperty<BorderSide?>.fromMap(
                widgetStateMap<BorderSide?>((Set<WidgetState> states) {
        ...
        equalsIgnoringHashCodes(
          OutlinedButtonThemeData(
            style: ButtonStyle(
              ...
              foregroundColor: WidgetStateProperty<Color?>.fromMap(
                widgetStateMap<Color?>((Set<WidgetState> states) {
                  if (states.contains(WidgetState.disabled)) {
            ...
            style: ButtonStyle(
              ...
              side: WidgetStateProperty<BorderSide?>.fromMap(
                widgetStateMap<BorderSide?>((Set<WidgetState> states) {
                  ...
                  return BorderSide(color: colorScheme.tertiary, width: 1.0);
                }, _outlinedSideStates),
              ),
            ),
          ).toString(),
  ...
  group('WITH: FlexSubTheme.progressIndicatorTheme ', () {
    ...
    test('ProgressIndicator FST25PI.1: GIVEN a default '
      ...
      final ProgressIndicatorThemeData progressTheme =
          FlexSubThemes.progressIndicatorTheme(colorScheme: colorScheme);
      expect(
        progressTheme,
        equals(
          ProgressIndicatorThemeData(stopIndicatorColor: colorScheme.primary),
        ),
      );
    });
  ...
  group('WITH: FlexSubTheme.sliderTheme ', () {
    ...
    test('Slider FST27.3: GIVEN a FlexSubTheme.sliderTheme '
      ...
      expect(m.valueIndicatorShape, equals(null));
      expect(
  ...
  group('WITH: FlexSubTheme.switchTheme ', () {
    ...
    test('Switch FST29.4 dark-states: Does Switch have right '
      ...
      expect(
        ...
        isSameColorAs(colorScheme.primary.withAlpha(kAlphaM2SwitchTrackDark)),
      );
      // Default states
      expect(
        FlexSubThemes.switchTheme(
          ...
          SwitchThemeData(
            ...
            trackColor: WidgetStateProperty<Color>.fromMap(
              widgetStateMap<Color>((Set<WidgetState> states) {
                ...
                if (states.contains(WidgetState.selected)) {
                  return colorScheme.tertiary.withAlpha(
                    kAlphaM2SwitchTrackLight,
                  );
                }
                return colorScheme.tertiary.withAlpha(
