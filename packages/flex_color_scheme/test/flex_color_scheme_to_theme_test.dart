  ...
  group('FCS7: WITH FlexColorScheme.toTheme ', () {
    ...
    test('FCS7.2: GIVEN a FlexColorScheme.light theme FROM scheme "material" '
      ...
      expect(
        ...
        isSameColorAs(const Color(0xfffbfbfb)),
      );
    });
    test('FCS7.21: GIVEN a FlexColorScheme.dark theme FROM scheme "material" '
      ...
      expect(
        ...
        isSameColorAs(const Color(0xff080808)),
      );
    });
    ...
    test('FCS7.27: GIVEN a FlexColorScheme.dark theme FROM scheme "material" '
        ...
        'indicator color primary.', () {
      expect(
        tDarkL.tabBarTheme.indicatorColor,
    ...
    test('FCS7.36: GIVEN a FlexColorScheme.light theme FROM scheme "material" '
      ...
      expect(
        ...
        isSameColorAs(const Color(0xfff5f2fb)),
      );
    });
    test('FCS7.37: GIVEN a FlexColorScheme.dark theme FROM scheme "material" '
      ...
      expect(
        ...
        isSameColorAs(const Color(0xff0f0c11)),
      );
    });
    ...
    test('FCS7.51: GIVEN a FlexColorScheme.light theme FROM scheme "material" '
      ...
      expect(
        ...
        isSameColorAs(const Color(0xffe0cff9)),
      );
    });
    test('FCS7.52: GIVEN a FlexColorScheme.dark theme FROM scheme "material" '
      ...
      expect(
        ...
        isSameColorAs(const Color(0xff271e33)),
      );
    });
    ...
    test('FCS7.67: GIVEN a FlexColorScheme.light theme FROM scheme "material" '
      ...
      expect(
        ...
        isSameColorAs(const Color(0xffcbacf7)),
      );
    });
    test('FCS7.68: GIVEN a FlexColorScheme.dark theme FROM scheme "material" '
      ...
      expect(
        ...
        isSameColorAs(const Color(0xff402f54)),
      );
    });
    ...
    test('FCS7.74: GIVEN a FlexColorScheme.dark theme FROM scheme "material" '
        ...
        'indicator color primary.', () {
      expect(
        tDarkH.tabBarTheme.indicatorColor,
    ...
    final ColorScheme realRawSchemeLight = ColorScheme(
      ...
      secondaryContainer: const Color(
        0xff57c8d3,
      ).brighten(14).blend(Colors.white, 50),
      onSecondaryContainer: const Color(0xff000000),
    ...
    final FlexColorScheme fcsDarkH2Raw = FlexColorScheme(
      ...
      colorScheme: ColorScheme(
        ...
        secondaryContainer: const Color(
          0xff68cdd7,
        ).darken(25).blend(Colors.black, 50),
        onSecondaryContainer: const Color(0xffffffff),
        //
        secondaryFixed: _fixedColor(const Color(0xff57c8d3)),
        secondaryFixedDim: _fixedDimColor(const Color(0xff57c8d3)),
    ...
    test('FCS7.82-2L indicator: GIVEN tabBarIndicatorUsedColor: '
      ...
      expect(
        tLightHb.tabBarTheme.indicatorColor,
        tLightHb.colorScheme.secondary,
      );
    });
    ...
    final TextTheme nLightT = ThemeData(
    ...
    final TextTheme nLightP = ThemeData(
      typography: Typography.material2021(),
    ).primaryTextTheme;
    test(
    ...
    final Color nDarkPColor = FlexColorScheme.dark(
      useMaterial3: false,
    ...
    test('FCS7.102d GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      final Color background = refTheme.colorScheme.surfaceContainer.withValues(
        alpha: 0.9,
      );
      ...
      expect(
        ...
        equalsIgnoringHashCodes(
          SliderThemeData(
            ...
            inactiveTrackColor: colorScheme.primary.withAlpha(
              kAlphaLowDisabled,
            ),
            ...
            activeTickMarkColor: colorScheme.onPrimary.withAlpha(
              kAlphaSliderTickMark,
            ),
            inactiveTickMarkColor: colorScheme.primary.withAlpha(
              kAlphaSliderTickMark,
            ),
            disabledActiveTickMarkColor: colorScheme.onPrimary.withAlpha(
              kAlphaVeryLowDisabled,
            ),
    ...
    test('FCS7.106a GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      final FlexColorScheme fcs = FlexColorScheme.light(
        ...
        tones: FlexTones.jolly(
          Brightness.light,
        ).onMainsUseBW().onSurfacesUseBW(),
      );
    ...
    test('FCS7.112a GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      // DropDownMenu
      expect(
        theme.dropdownMenuTheme.menuStyle!.surfaceTintColor!.resolve(
          <WidgetState>{},
        ),
        equals(Colors.transparent),
      );
  ...
  group('FCS11: TextTheme and ISSUE-151-Light WITH FlexColorScheme.toTheme ', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final ColorScheme scheme = ColorScheme.fromSeed(
          brightness: Brightness.light,
          seedColor: const Color(0xffd9008c),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          pTextTheme.displayMedium!.color,
          equals(const Color(0xd8495042)),
        );
        expect(pTextTheme.displaySmall!.color, equals(const Color(0xd8344548)));
        expect(
          pTextTheme.headlineLarge!.color,
          equals(const Color(0xd8603e53)),
        );
        expect(
          pTextTheme.headlineMedium!.color,
          equals(const Color(0xd8775e51)),
        );
        expect(
          pTextTheme.headlineSmall!.color,
          equals(const Color(0xd8704f63)),
        );
