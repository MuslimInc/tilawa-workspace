  ...
  group('FSC1: WITH FlexSchemeColor ', () {
    ...
    test('FSC1.11-light-1: GIVEN a FlexSchemeColor.from primary '
      ...
      testFlexSchemeColorEquality(
        ...
        FlexSchemeColor(
          ...
          error: FlexColor.materialLightError,
          errorContainer: FlexColor.lightErrorContainer(
    ...
    test('FSC1.11-dark-1: GIVEN a FlexSchemeColor.from primary  '
      ...
      testFlexSchemeColorEquality(
        ...
        FlexSchemeColor(
          ...
          errorContainer: FlexColor.darkErrorContainer(
            FlexColor.materialDarkError,
          ),
        ),
      );
    ...
    test('FSC1.14: GIVEN a FlexSchemeColor.effective(SchemeColors, 4) '
      ...
      expect(
        ...
        m1Full.copyWith(
          ...
          tertiaryLightRef: m1Full.primaryLightRef!.lighten(
            kDarkenPrimaryContainer,
          ),
    ...
    test('FSC1.15: GIVEN a FlexSchemeColor.effective(SchemeColors, 3) '
      ...
      expect(
        ...
        m1Full.copyWith(
          secondaryContainer: m1Full.secondary.darken(
    ...
    test('FSC1.19: GIVEN a FlexSchemeColor.effective(SchemeColors, 5) '
      ...
      expect(
        ...
        m1Full.copyWith(
          tertiaryContainer: m1Full.tertiary
              .brighten(18)
              .blend(Colors.white, 50),
        ),
      );
    });
    ...
    test('FSC1.21: GIVEN a FlexSchemeColor.effective(SchemeColors, 3) '
      ...
      expect(
        ...
        m1Full.copyWith(
          secondaryContainer: m1Full.secondary
              .brighten(14)
              .blend(Colors.white, 50),
          tertiary: m1Full.primary.brighten(15),
          tertiaryLightRef: m1Full.primaryLightRef!.brighten(15),
    ...
    test('FSC1.23: GIVEN a FlexSchemeColor.effective(SchemeColors, 1) '
      ...
      expect(
        ...
        m1Full.copyWith(
          ...
          secondaryContainer: m1Full.primary
              .darken()
              .brighten(20)
              .blend(Colors.white, 60),
          tertiary: m1Full.primary.brighten(15),
    ...
    test('FSC1.25: GIVEN a FlexSchemeColor.effective(SchemeColors, 5) '
      ...
      expect(
        ...
        m1FullD.copyWith(
          tertiaryContainer: m1FullD.tertiary
              .darken(15)
    ...
    test('FSC1.26: GIVEN a FlexSchemeColor.effective(SchemeColors, 4) '
      ...
      expect(
        ...
        m1FullD.copyWith(
          ...
          tertiaryContainer: m1FullD.primary
              .brighten(15)
              .darken(20)
    ...
    test('FSC1.27: GIVEN a FlexSchemeColor.effective(SchemeColors, 3) '
      ...
      expect(
        ...
        m1FullD.copyWith(
          secondaryContainer: m1FullD.secondary
              .darken(25)
              .blend(Colors.black, 50),
          tertiary: m1FullD.primary.brighten(15),
          tertiaryLightRef: m1FullD.primaryLightRef!.brighten(15),
          tertiaryContainer: m1FullD.primary
              .brighten(15)
    ...
    test('FSC1.29: GIVEN a FlexSchemeColor.effective(SchemeColors, 1) '
      ...
      expect(
        ...
        m1FullD.copyWith(
          ...
          secondaryContainer: m1FullD.primary
              .darken()
              .brighten(20)
    ...
    test('FSC1.32: GIVEN a FlexSchemeColor.effective(SchemeColors, 4, '
      ...
      expect(
        ...
        m1Swap.copyWith(
          ...
          tertiaryLightRef: m1Swap.primaryLightRef!.lighten(
            kDarkenPrimaryContainer,
          ),
    ...
    test(
      ...
      () {
        expect(
          ...
          m1Swap.copyWith(
            secondaryContainer: m1Swap.secondary.darken(
              kDarkenSecondaryContainerFromSecondary,
            ),
            tertiary: m1Swap.primary.lighten(kDarkenPrimaryContainer),
            tertiaryLightRef: m1Swap.primaryLightRef!.lighten(
