...
void main() {
  ...
  group('FS1: WITH FlexSplashType', () {
    test('FA1.01: test all splashFactory() types', () {
      ...
      expect(
        FlexSplashType.instantSplash.splashFactory(),
        FlexInstantSplash.splashFactory,
      );
      //
      expect(
        FlexSplashType.inkSparkle.splashFactory(),
        InkSparkle.splashFactory,
      );
      expect(
        FlexSplashType.inkSparkle.splashFactory(false, true),
        InkSplash.splashFactory,
      );
      expect(
        FlexSplashType.inkSparkle.splashFactory(true, true),
        InkRipple.splashFactory,
      );
      expect(
        FlexSplashType.inkSparkle.splashFactory(false, false),
        InkSparkle.splashFactory,
      );
    });
  });
