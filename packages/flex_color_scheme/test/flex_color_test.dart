...
void main() {
  ...
  group('FC3: WITH FlexColor material light high-contrast colors ', () {
    ...
    test(
      ...
      () {
        expect(
          FlexColor.materialLightTertiaryContainerHc,
          ml.tertiaryContainer,
        );
      },
    );
  ...
  group('FC4: WITH FlexColor material dark high-contrast colors', () {
    ...
    test(
      ...
      () {
        expect(
          FlexColor.materialDarkSecondaryContainerHc,
          md.secondaryContainer,
        );
      },
    );
  ...
  group('FC5: WITH FlexColor test color definitions are as specified', () {
    ...
    test('FC5 colors Material 2 high contrast', () {
      expect(
        FlexColor.materialHcDescription,
    ...
    test('FC5 colors Material 2 high contrast light', () {
      expect(
        FlexColor.materialLightPrimaryContainerHc,
        const Color(0xffb6b6ff),
      );
    });
    test('FC5 colors Material 2 high contrast light', () {
    ...
    test('FC5 colors Material 2 high contrast light', () {
      expect(
        FlexColor.materialLightSecondaryContainerHc,
        const Color(0xFFC8F9F7),
      );
    });
    test('FC5 colors Material 2 high contrast light', () {
      expect(
        FlexColor.materialLightSecondaryVariantHc,
    ...
    test('FC5 colors Material 2 high contrast dark', () {
      expect(
        FlexColor.materialDarkTertiaryContainerHc,
        const Color(0xFF043232),
      );
    });
    //
    ...
    test('FC5 colors Hippie blue', () {
      expect(
        FlexColor.hippieBlueDescription,
    ...
    test('FC5 colors Hippie blue light', () {
      expect(
        FlexColor.hippieBlueLightPrimaryContainer,
        const Color(0xFF9CEBEB),
      );
    });
    test('FC5 colors Hippie blue light', () {
    ...
    test('FC5 colors Hippie blue light', () {
      expect(
        FlexColor.hippieBlueLightSecondaryContainer,
        const Color(0xFFFFDAD7),
      );
    });
    test('FC5 colors Hippie blue light', () {
      expect(
        FlexColor.hippieBlueLightSecondaryVariant,
    ...
    test('FC5 colors Hippie blue light', () {
      expect(
        FlexColor.hippieBlueLightTertiaryContainer,
        const Color(0xFFFCBDBD),
      );
    });
    ...
    test('FC5 colors Hippie blue dark', () {
      expect(
        FlexColor.hippieBlueDarkSecondaryContainer,
        const Color(0xFF92001A),
      );
    });
    test('FC5 colors Hippie blue dark', () {
      expect(
        FlexColor.hippieBlueDarkSecondaryVariant,
    ...
    test('FC5 colors Hippie blue dark', () {
      expect(
        FlexColor.hippieBlueDarkTertiaryContainer,
        const Color(0xFF580810),
      );
    });
    ...
    test('FC5 colors Aqua blue light', () {
      expect(
        FlexColor.aquaBlueLightSecondaryContainer,
        const Color(0xFF91F4E8),
      );
    });
    test('FC5 colors Aqua blue light', () {
      expect(
        FlexColor.aquaBlueLightSecondaryVariant,
    ...
    test('FC5 colors Aqua blue dark', () {
      expect(
        FlexColor.aquaBlueDarkSecondaryVariant,
    ...
    test('FC5 colors Brand blues', () {
      expect(
        FlexColor.brandBlueDescription,
    ...
    test('FC5 colors Brand blues light', () {
      expect(
        FlexColor.brandBlueLightSecondaryContainer,
        const Color(0xFFCBE5FF),
      );
    });
    test('FC5 colors Brand blues light', () {
      expect(
        FlexColor.brandBlueLightSecondaryVariant,
    ...
    test('FC5 colors Brand blues light', () {
      expect(
        FlexColor.brandBlueLightTertiaryContainer,
    ...
    test('FC5 colors Brand blues dark', () {
      expect(
        FlexColor.brandBlueDarkSecondaryContainer,
        const Color(0xFF004B75),
      );
    });
    test('FC5 colors Brand blues dark', () {
      expect(
        FlexColor.brandBlueDarkSecondaryVariant,
    ...
    test('FC5 colors Deep blue sea light', () {
      expect(
        FlexColor.deepBlueLightSecondaryContainer,
        const Color(0xFFA9EDFF),
      );
    });
    test('FC5 colors Deep blue sea light', () {
      expect(
        FlexColor.deepBlueLightSecondaryVariant,
    ...
    test('FC5 colors Pink sakura light', () {
      expect(
        FlexColor.sakuraLightSecondaryVariant,
        FlexColor.sakuraLightTertiary,
      );
    });
    test('FC5 colors Pink sakura light', () {
    ...
    test('FC5 colors Pink sakura dark', () {
      expect(
        FlexColor.sakuraDarkSecondaryVariant,
        FlexColor.sakuraDarkTertiary,
      );
    });
    test('FC5 colors Pink sakura dark', () {
    ...
    test('FC5 colors Oh Mandy red light', () {
      expect(
        FlexColor.mandyRedLightSecondaryContainer,
        const Color(0xFF90F2FC),
      );
    });
    test('FC5 colors Oh Mandy red light', () {
    ...
    test('FC5 colors Oh Mandy red dark', () {
      expect(
        FlexColor.mandyRedDarkSecondaryVariant,
    ...
    test('FC5 colors Red red wine light', () {
      expect(
        FlexColor.redWineLightSecondaryVariant,
    ...
    test('FC5 colors Red red wine dark', () {
      expect(
        FlexColor.redWineDarkSecondaryVariant,
        FlexColor.redWineDarkTertiary,
      );
    });
    test('FC5 colors Red red wine dark', () {
    ...
    test('FC5 colors Purple brown light', () {
      expect(
        FlexColor.purpleBrownLightPrimaryContainer,
        const Color(0xFFB9A6A8),
      );
    });
    test('FC5 colors Purple brown light', () {
    ...
    test('FC5 colors Purple brown light', () {
      expect(
        FlexColor.purpleBrownLightSecondaryContainer,
        const Color(0xFFE9CEDD),
      );
    });
    test('FC5 colors Purple brown light', () {
      expect(
        FlexColor.purpleBrownLightSecondaryVariant,
    ...
    test('FC5 colors Purple brown light', () {
      expect(
        FlexColor.purpleBrownLightTertiaryContainer,
        const Color(0xFFE3B0C5),
      );
    });
    ...
    test('FC5 colors Purple brown dark', () {
      expect(
        FlexColor.purpleBrownDarkPrimaryContainer,
        const Color(0xFF682A2C),
      );
    });
    test('FC5 colors Purple brown dark', () {
    ...
    test('FC5 colors Purple brown dark', () {
      expect(
        FlexColor.purpleBrownDarkSecondaryContainer,
        const Color(0xFF6A2357),
      );
    });
    test('FC5 colors Purple brown dark', () {
      expect(
        FlexColor.purpleBrownDarkSecondaryVariant,
    ...
    test('FC5 colors Purple brown dark', () {
      expect(
        FlexColor.purpleBrownDarkTertiaryContainer,
        const Color(0xFF501A3C),
      );
    });
    ...
    test('FC5 colors Green forest light', () {
      expect(
        FlexColor.greenLightSecondaryVariant,
        FlexColor.greenLightTertiary,
      );
    });
    test('FC5 colors Green forest light', () {
    ...
    test('FC5 colors Green money light', () {
      expect(
        FlexColor.moneyLightSecondaryVariant,
        FlexColor.moneyLightTertiary,
      );
    });
    test('FC5 colors Green money light', () {
    ...
    test('FC5 colors Green jungle light', () {
      expect(
        FlexColor.jungleLightSecondaryVariant,
        FlexColor.jungleLightTertiary,
      );
    });
    test('FC5 colors Green jungle light', () {
    ...
    test('FC5 colors Green jungle dark', () {
      expect(
        FlexColor.jungleDarkSecondaryVariant,
        FlexColor.jungleDarkTertiary,
      );
    });
    test('FC5 colors Green jungle dark', () {
    ...
    test('FC5 colors Grey law light', () {
      expect(
        FlexColor.greyLawLightSecondaryVariant,
    ...
    test('FC5 colors Willow and wasabi light', () {
      expect(
        FlexColor.wasabiLightSecondaryVariant,
        FlexColor.wasabiLightTertiary,
      );
    });
    test('FC5 colors Willow and wasabi light', () {
    ...
    test('FC5 colors Willow and wasabi dark', () {
      expect(
        FlexColor.wasabiDarkSecondaryVariant,
        FlexColor.wasabiDarkTertiary,
      );
    });
    test('FC5 colors Willow and wasabi dark', () {
    ...
    test('FC5 colors Mango mojito light', () {
      expect(
        FlexColor.mangoLightSecondaryVariant,
        FlexColor.mangoLightTertiary,
      );
    });
    test('FC5 colors Mango mojito light', () {
    ...
    test('FC5 colors Amber blue light', () {
      expect(
        FlexColor.amberLightSecondaryVariant,
        FlexColor.amberLightTertiary,
      );
    });
    test('FC5 colors Amber blue light', () {
    ...
    test('FC5 colors Vesuvius burned light', () {
      expect(
        FlexColor.vesuviusBurnLightPrimaryContainer,
        const Color(0xFFD1AA99),
      );
    });
    test('FC5 colors Vesuvius burned light', () {
      expect(
        FlexColor.vesuviusBurnLightPrimaryVariant,
    ...
    test('FC5 colors Vesuvius burned light', () {
      expect(
        FlexColor.vesuviusBurnLightSecondaryContainer,
        const Color(0xFFA3C4C7),
      );
    });
    test('FC5 colors Vesuvius burned light', () {
      expect(
        FlexColor.vesuviusBurnLightSecondaryVariant,
    ...
    test('FC5 colors Vesuvius burned light', () {
      expect(
        FlexColor.vesuviusBurnLightTertiaryContainer,
    ...
    test('FC5 colors Vesuvius burned dark', () {
      expect(
        FlexColor.vesuviusBurnDarkPrimaryContainer,
        const Color(0xFF874E32),
      );
    });
    test('FC5 colors Vesuvius burned dark', () {
    ...
    test('FC5 colors Vesuvius burned dark', () {
      expect(
        FlexColor.vesuviusBurnDarkSecondaryContainer,
        const Color(0xFF0D494D),
      );
    });
    test('FC5 colors Vesuvius burned dark', () {
      expect(
        FlexColor.vesuviusBurnDarkSecondaryVariant,
    ...
    test('FC5 colors Vesuvius burned dark', () {
      expect(
        FlexColor.vesuviusBurnDarkTertiaryContainer,
        const Color(0xFF023639),
      );
    });
    ...
    test('FC5 colors Deep purple light', () {
      expect(
        FlexColor.deepPurpleLightPrimaryContainer,
    ...
    test('FC5 colors Deep purple light', () {
      expect(
        FlexColor.deepPurpleLightSecondaryContainer,
        const Color(0xFFCFE4FF),
      );
    });
    test('FC5 colors Deep purple light', () {
      expect(
        FlexColor.deepPurpleLightSecondaryVariant,
    ...
    test('FC5 colors Deep purple light', () {
      expect(
        FlexColor.deepPurpleLightTertiaryContainer,
        const Color(0xFF9FCBF1),
      );
    });
    ...
    test('FC5 colors Deep purple dark', () {
      expect(
        FlexColor.deepPurpleDarkSecondaryContainer,
        const Color(0xFF00497B),
      );
    });
    test('FC5 colors Deep purple dark', () {
      expect(
        FlexColor.deepPurpleDarkSecondaryVariant,
    ...
    test('FC5 colors Deep purple dark', () {
      expect(
        FlexColor.deepPurpleDarkTertiaryContainer,
        const Color(0xFF0179B6),
      );
    });
    ...
    test('FC5 colors Ebony clay light', () {
      expect(
        FlexColor.ebonyClayLightSecondaryContainer,
        const Color(0xFF8FC3AD),
      );
    });
    test('FC5 colors Ebony clay light', () {
      expect(
        FlexColor.ebonyClayLightSecondaryVariant,
    ...
    test('FC5 colors Ebony clay light', () {
      expect(
        FlexColor.ebonyClayLightTertiaryContainer,
        const Color(0xFF82BCB5),
      );
    });
    ...
    test('FC5 colors Ebony clay dark', () {
      expect(
        FlexColor.ebonyClayDarkSecondaryContainer,
        const Color(0xFF0B5341),
      );
    });
    test('FC5 colors Ebony clay dark', () {
      expect(
        FlexColor.ebonyClayDarkSecondaryVariant,
    ...
    test('FC5 colors Barossa light', () {
      expect(
        FlexColor.barossaLightSecondaryVariant,
    ...
    test('FC5 colors Barossa dark', () {
      expect(
        FlexColor.barossaDarkSecondaryVariant,
        FlexColor.barossaDarkTertiary,
      );
    });
    test('FC5 colors Barossa dark', () {
    ...
    test('FC5 colors Shark and orange light', () {
      expect(
        FlexColor.sharkLightSecondaryVariant,
        FlexColor.sharkLightTertiary,
      );
    });
    test('FC5 colors Shark and orange light', () {
    ...
    test('FC5 colors Big stone tulip light', () {
      expect(
        FlexColor.bigStoneLightSecondaryContainer,
        const Color(0xFFE0BD80),
      );
    });
    test('FC5 colors Big stone tulip light', () {
      expect(
        FlexColor.bigStoneLightSecondaryVariant,
    ...
    test('FC5 colors Big stone tulip dark', () {
      expect(
        FlexColor.bigStoneDarkSecondaryVariant,
    ...
    test('FC5 colors Damask and lunar light', () {
      expect(
        FlexColor.damaskLightSecondaryVariant,
        FlexColor.damaskLightTertiary,
      );
    });
    test('FC5 colors Damask and lunar light', () {
    ...
    test('FC5 colors Damask and lunar dark', () {
      expect(
        FlexColor.damaskDarkSecondaryVariant,
        FlexColor.damaskDarkTertiary,
      );
    });
    test('FC5 colors Damask and lunar dark', () {
    ...
    test('FC5 colors Bahama and trinidad light', () {
      expect(
        FlexColor.bahamaBlueLightSecondaryContainer,
        const Color(0xFFFFDBCD),
      );
    });
    test('FC5 colors Bahama and trinidad light', () {
      expect(
        FlexColor.bahamaBlueLightSecondaryVariant,
    ...
    test('FC5 colors Bahama and trinidad light', () {
      expect(
        FlexColor.bahamaBlueLightTertiaryContainer,
    ...
    test('FC5 colors Bahama and trinidad dark', () {
      expect(
        FlexColor.bahamaBlueDarkSecondaryContainer,
        const Color(0xFFDD520F),
      );
    });
    test('FC5 colors Bahama and trinidad dark', () {
      expect(
        FlexColor.bahamaBlueDarkSecondaryVariant,
    ...
    test('FC5 colors Bahama and trinidad dark', () {
      expect(
        FlexColor.bahamaBlueDarkTertiaryContainer,
        const Color(0xFF3A7292),
      );
    });
    ...
    test('FC5 colors Mallard and valencia light', () {
      expect(
        FlexColor.mallardGreenLightPrimaryContainer,
        const Color(0xFFA3B58A),
      );
    });
    test('FC5 colors Mallard and valencia light', () {
      expect(
        FlexColor.mallardGreenLightPrimaryVariant,
        const Color(0xFF779151),
      );
    });
    test('FC5 colors Mallard and valencia light', () {
    ...
    test('FC5 colors Mallard and valencia light', () {
      expect(
        FlexColor.mallardGreenLightSecondaryContainer,
        const Color(0xFFFFDAD6),
      );
    });
    test('FC5 colors Mallard and valencia light', () {
      expect(
        FlexColor.mallardGreenLightSecondaryVariant,
    ...
    test('FC5 colors Mallard and valencia light', () {
      expect(
        FlexColor.mallardGreenLightTertiaryContainer,
    ...
    test('FC5 colors Mallard and valencia dark', () {
      expect(
        FlexColor.mallardGreenDarkPrimaryContainer,
        const Color(0xFF2D4421),
      );
    });
    test('FC5 colors Mallard and valencia dark', () {
    ...
    test('FC5 colors Mallard and valencia dark', () {
      expect(
        FlexColor.mallardGreenDarkSecondaryContainer,
        const Color(0xFF501116),
      );
    });
    test('FC5 colors Mallard and valencia dark', () {
      expect(
        FlexColor.mallardGreenDarkSecondaryVariant,
    ...
    test('FC5 colors Mallard and valencia dark', () {
      expect(
        FlexColor.mallardGreenDarkTertiaryContainer,
        const Color(0xFF454B00),
      );
    });
    ...
    test('FC5 colors Espresso and crema light', () {
      expect(
        FlexColor.espressoLightSecondaryContainer,
        const Color(0xFFFFDE9C),
      );
    });
    test('FC5 colors Espresso and crema light', () {
      expect(
        FlexColor.espressoLightSecondaryVariant,
    ...
    test('FC5 colors Espresso and crema dark', () {
      expect(
        FlexColor.espressoDarkSecondaryVariant,
    ...
    test('FC5 colors Outer space stage light', () {
      expect(
        FlexColor.outerSpaceLightSecondaryContainer,
        const Color(0xFFFFDBC8),
      );
    });
    test('FC5 colors Outer space stage light', () {
      expect(
        FlexColor.outerSpaceLightSecondaryVariant,
    ...
    test('FC5 colors Outer space stage light', () {
      expect(
        FlexColor.outerSpaceLightTertiaryContainer,
        const Color(0xFFB5CDDB),
      );
    });
    ...
    test('FC5 colors Outer space stage dark', () {
      expect(
        FlexColor.outerSpaceDarkSecondaryContainer,
        const Color(0xFFC05402),
      );
    });
    test('FC5 colors Outer space stage dark', () {
      expect(
        FlexColor.outerSpaceDarkSecondaryVariant,
    ...
    test('FC5 colors Outer space stage dark', () {
      expect(
        FlexColor.outerSpaceDarkTertiaryContainer,
        const Color(0xFF285C71),
      );
    });
    ...
    test('FC5 colors Blue whale light', () {
      expect(
        FlexColor.blueWhaleLightSecondaryContainer,
        const Color(0xFFFFAD91),
      );
    });
    test('FC5 colors Blue whale light', () {
      expect(
        FlexColor.blueWhaleLightSecondaryVariant,
    ...
    test('FC5 colors Blue whale light', () {
      expect(
        FlexColor.blueWhaleLightTertiaryContainer,
        const Color(0xFFFFBF93),
      );
    });
    ...
    test('FC5 colors Blue whale dark', () {
      expect(
        FlexColor.blueWhaleDarkSecondaryContainer,
        const Color(0xFFA3290F),
      );
    });
    test('FC5 colors Blue whale dark', () {
      expect(
        FlexColor.blueWhaleDarkSecondaryVariant,
    ...
    test('FC5 colors San Juan blue light', () {
      expect(
        FlexColor.sanJuanBlueLightPrimaryContainer,
        const Color(0xFFA4C4ED),
      );
    });
    test('FC5 colors San Juan blue light', () {
    ...
    test('FC5 colors San Juan blue light', () {
      expect(
        FlexColor.sanJuanBlueLightSecondaryContainer,
        const Color(0xFFFFC4C6),
      );
    });
    test('FC5 colors San Juan blue light', () {
      expect(
        FlexColor.sanJuanBlueLightSecondaryVariant,
    ...
    test('FC5 colors San Juan blue light', () {
      expect(
        FlexColor.sanJuanBlueLightTertiaryContainer,
    ...
    test('FC5 colors San Juan blue dark', () {
      expect(
        FlexColor.sanJuanBlueDarkPrimaryContainer,
        const Color(0xFF375778),
      );
    });
    test('FC5 colors San Juan blue dark', () {
    ...
    test('FC5 colors San Juan blue dark', () {
      expect(
        FlexColor.sanJuanBlueDarkSecondaryContainer,
        const Color(0xFFAE424F),
      );
    });
    test('FC5 colors San Juan blue dark', () {
      expect(
        FlexColor.sanJuanBlueDarkSecondaryVariant,
    ...
    test('FC5 colors San Juan blue dark', () {
      expect(
        FlexColor.sanJuanBlueDarkTertiaryContainer,
        const Color(0xFF96434F),
      );
    });
    ...
    test('FC5 colors Rosewood light', () {
      expect(
        FlexColor.rosewoodLightSecondaryContainer,
        const Color(0xFFFFDEA3),
      );
    });
    test('FC5 colors Rosewood light', () {
      expect(
        FlexColor.rosewoodLightSecondaryVariant,
    ...
    test('FC5 colors Rosewood dark', () {
      expect(
        FlexColor.rosewoodDarkSecondaryVariant,
    ...
    test('FC5 colors Blumine light', () {
      expect(
        FlexColor.blumineBlueLightPrimaryContainer,
        const Color(0xFFA1CBCF),
      );
    });
    test('FC5 colors Blumine light', () {
    ...
    test('FC5 colors Blumine light', () {
      expect(
        FlexColor.blumineBlueLightSecondaryContainer,
        const Color(0xFFFFDEA5),
      );
    });
    test('FC5 colors Blumine light', () {
      expect(
        FlexColor.blumineBlueLightSecondaryVariant,
    ...
    test('FC5 colors Blumine light', () {
      expect(
        FlexColor.blumineBlueLightTertiaryContainer,
    ...
    test('FC5 colors Blumine dark', () {
      expect(
        FlexColor.blumineBlueDarkPrimaryContainer,
        const Color(0xFF04666F),
      );
    });
    test('FC5 colors Blumine dark', () {
    ...
    test('FC5 colors Blumine dark', () {
      expect(
        FlexColor.blumineBlueDarkSecondaryContainer,
        const Color(0xFF9E7910),
      );
    });
    test('FC5 colors Blumine dark', () {
      expect(
        FlexColor.blumineBlueDarkSecondaryVariant,
    ...
    test('FC5 colors Blumine dark', () {
      expect(
        FlexColor.blumineBlueDarkTertiaryContainer,
    ...
    test('FC5 colors Flutter Dash light', () {
      expect(
        FlexColor.dashBlueLightSecondaryContainer,
        const Color(0xFF99CCF9),
      );
    });
    test('FC5 colors Flutter Dash light', () {
    ...
    test('FC5 colors M3 Baseline light', () {
      expect(
        FlexColor.materialBaselineLightPrimaryContainer,
    ...
    test('FC5 colors M3 Baseline light', () {
      expect(
        FlexColor.materialBaselineLightSecondaryContainer,
    ...
    test('FC5 colors M3 Baseline light', () {
      expect(
        FlexColor.materialBaselineLightTertiaryContainer,
    ...
    test('FC5 colors M3 Baseline dark', () {
      expect(
        FlexColor.materialBaselineDarkPrimaryContainer,
    ...
    test('FC5 colors M3 Baseline dark', () {
      expect(
        FlexColor.materialBaselineDarkSecondaryContainer,
    ...
    test('FC5 colors M3 Baseline dark', () {
      expect(
        FlexColor.materialBaselineDarkTertiaryContainer,
    ...
    test('FC5 colors Verdun green light', () {
      expect(
        FlexColor.verdunHemlockLightPrimaryContainer,
    ...
    test('FC5 colors Verdun green light', () {
      expect(
        FlexColor.verdunHemlockLightSecondaryContainer,
    ...
    test('FC5 colors Verdun green light', () {
      expect(
        FlexColor.verdunHemlockLightTertiaryContainer,
    ...
    test('FC5 colors Verdun green dark', () {
      expect(
        FlexColor.verdunHemlockDarkPrimaryContainer,
        const Color(0xFF494A00),
      );
    });
    test('FC5 colors Verdun green dark', () {
    ...
    test('FC5 colors Verdun green dark', () {
      expect(
        FlexColor.verdunHemlockDarkSecondaryContainer,
    ...
    test('FC5 colors Verdun green dark', () {
      expect(
        FlexColor.verdunHemlockDarkTertiaryContainer,
    ...
    test('FC5 colors Dell genoa green light', () {
      expect(
        FlexColor.dellGenoaGreenLightPrimaryContainer,
    ...
    test('FC5 colors Dell genoa green light', () {
      expect(
        FlexColor.dellGenoaGreenLightSecondaryContainer,
    ...
    test('FC5 colors Dell genoa green light', () {
      expect(
        FlexColor.dellGenoaGreenLightTertiaryContainer,
    ...
    test('FC5 colors Dell genoa green dark', () {
      expect(
        FlexColor.dellGenoaGreenDarkPrimaryContainer,
    ...
    test('FC5 colors Dell genoa green dark', () {
      expect(
        FlexColor.dellGenoaGreenDarkSecondaryContainer,
    ...
    test('FC5 colors Dell genoa green dark', () {
      expect(
        FlexColor.dellGenoaGreenDarkTertiaryContainer,
    ...
    test('FC5 colors purple M3 light', () {
      expect(
        FlexColor.purpleM3LightSecondaryContainer,
    ...
    test('FC5 colors indigo M3 light', () {
      expect(
        FlexColor.indigoM3LightSecondaryContainer,
    ...
    test('FC5 colors yellow M3 light', () {
      expect(
        FlexColor.yellowM3LightSecondaryContainer,
        const Color(0xFFF8F591),
      );
    });
    test('FC5 colors yellow M3 light', () {
    ...
    test('FC5 colors orange M3 light', () {
      expect(
        FlexColor.orangeM3LightSecondaryContainer,
    ...
    test('FC5 colors deepOrange M3 light', () {
      expect(
        FlexColor.deepOrangeM3LightPrimaryContainer,
    ...
    test('FC5 colors deepOrange M3 light', () {
      expect(
        FlexColor.deepOrangeM3LightSecondaryContainer,
    ...
    test('FC5 colors deepOrange M3 light', () {
      expect(
        FlexColor.deepOrangeM3LightTertiaryContainer,
    ...
    test('FC5 colors deepOrange M3 dark', () {
      expect(
        FlexColor.deepOrangeM3DarkPrimaryContainer,
    ...
    test('FC5 colors deepOrange M3 dark', () {
      expect(
        FlexColor.deepOrangeM3DarkSecondaryContainer,
    ...
    test('FC5 colors deepOrange M3 dark', () {
      expect(
        FlexColor.deepOrangeM3DarkTertiaryContainer,
        const Color(0xFF2F4F11),
      );
    });
    ...
    test('FC5 colors blackWhite light', () {
      expect(
        FlexColor.blackWhiteLightPrimaryContainer,
    ...
    test('FC5 colors blackWhite light', () {
      expect(
        FlexColor.blackWhiteLightSecondaryContainer,
    ...
    test('FC5 colors blackWhite light', () {
      expect(
        FlexColor.blackWhiteLightTertiaryContainer,
    ...
    test('FC5 colors blackWhite dark', () {
      expect(
        FlexColor.blackWhiteDarkSecondaryContainer,
    ...
    test('FC5 colors blackWhite dark', () {
      expect(
        FlexColor.blackWhiteDarkTertiaryContainer,
