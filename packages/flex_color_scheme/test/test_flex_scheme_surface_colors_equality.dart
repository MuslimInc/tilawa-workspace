...
void testFlexSchemeSurfaceColorsEquality(
  ...
  expect(
    scheme1.scaffoldBackground,
    isSameColorAs(scheme2.scaffoldBackground, threshold: threshold),
  );
  expect(
    scheme1.dialogBackground,
    isSameColorAs(scheme2.dialogBackground, threshold: threshold),
  );
}
