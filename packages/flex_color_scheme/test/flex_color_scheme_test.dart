...
void main() {
  ...
  group('FCS1: WITH FlexColorScheme ', () {
    ...
    test('FCS1.001-00: GIVEN a default FlexColorScheme() '
      ...
      expect(
        ...
        equalsIgnoringHashCodes(
          fcsMaterialLight.toTheme.toString(minLevel: DiagnosticLevel.fine),
        ),
      );
    });

    final FlexSchemeColor sc = FlexSchemeColor.from(
      primary: FlexColor.materialLightPrimary,
    );
    ...
    test('FCS1.07b: Test toStringShort implemented via debugFillProperties '
      ...
      expect(
        m5.toStringShort(),
        equalsIgnoringHashCodes('FlexColorScheme#00000'),
      );
    });
  ...
  group('FCS2: WITH FlexColorScheme.toScheme ', () {
    ...
    test('FCS2.01colors: GIVEN a Material2 light FlexColorScheme object '
      ...
      expect(
        lightFCS.errorContainer,
        isSameColorAs(lightScheme.errorContainer),
      );
      expect(
        lightFCS.onErrorContainer,
    ...
    test('FCS5.08a: GIVEN Brightness.dark divider:true + defined new color '
      ...
      expect(
        ...
        SystemUiOverlayStyle(
          ...
          systemNavigationBarDividerColor: const Color(
            0xFF2C2C2C,
