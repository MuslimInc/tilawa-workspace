...
void main() {
  ...
  group('TilawaTextField Goldens', () {
    ...
    goldenTest(
      'TilawaSkeletonBlock',
      fileName: 'atoms/tilawa_skeleton_block',
      builder: () => GoldenTestGroup(
        children: [
          GoldenTestScenario(
          ...
          GoldenTestScenario(
            ...
            child: TilawaPreviewWrapper(
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  TilawaSkeletonBlock(width: 200, height: 16, animate: false),
                  const SizedBox(height: 8),
                  TilawaSkeletonBlock(width: 160, height: 16, animate: false),
                  const SizedBox(height: 8),
                  TilawaSkeletonBlock(width: 180, height: 16, animate: false),
                ],
              ),
            ),
          ),
    ...
    goldenTest(
      'TilawaSkeletonBlock compact',
      fileName: 'atoms/tilawa_skeleton_block_compact',
      builder: () => GoldenTestGroup(
        children: [
          GoldenTestScenario(
          ...
          GoldenTestScenario(
            name: 'Text line (compact)',
            child: TilawaPreviewWrapper(
              density: TilawaDensity.compact,
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  TilawaSkeletonBlock(width: 200, height: 14, animate: false),
                  const SizedBox(height: 6),
                  TilawaSkeletonBlock(width: 160, height: 14, animate: false),
                ],
              ),
            ),
          ),
