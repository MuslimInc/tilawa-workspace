...
import 'page_content_v2.dart';

/// A horizontally swipeable Quran mushaf using Uthmanic Hafs v22 fonts.
class PageviewQuranV2 extends StatefulWidget {
  const PageviewQuranV2({
    super.key,
  ...
  @override
  State<PageviewQuranV2> createState() => _PageviewQuranV2State();
}

class _PageviewQuranV2State extends State<PageviewQuranV2> {
        ...
        child: PageView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return PageContentV2(
              ...
              onLongPressUp: (int surahNumber, int verseNumber) {},
              onLongPressCancel: (int surahNumber, int verseNumber) {},
              onLongPressDown:
                  (
                    int surahNumber,
                    int verseNumber,
