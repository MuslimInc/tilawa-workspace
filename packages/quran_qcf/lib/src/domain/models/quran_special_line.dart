...
@immutable
class QuranSpecialLine extends Equatable {
  ...
  @override
  List<Object?> get props => [type, surahNumber];
}

@immutable
class QuranSpecialLineCounts extends Equatable {
  ...
  @override
  List<Object?> get props => [headers, bismillahs];
