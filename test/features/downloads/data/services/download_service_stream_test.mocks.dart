...
// in muzakri/test/features/downloads/data/services/download_service_stream_test.dart.
...
class MockDownloadStatusMapper extends _i1.Mock
    implements _i7.DownloadStatusMapper {
  MockDownloadStatusMapper() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i8.DownloadStatus mapTaskStatusToDownloadStatus(
    _i4.DownloadTaskStatus? status,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#mapTaskStatusToDownloadStatus, [status]),
            returnValue: _i8.DownloadStatus.pending,
          )
          as _i8.DownloadStatus);
}
...
class MockDownloadIsolateManager extends _i1.Mock
    implements _i9.DownloadIsolateManager {
