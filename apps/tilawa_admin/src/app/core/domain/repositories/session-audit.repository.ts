...
export interface SessionAuditRepository {
  listTimelineByAggregateId(aggregateId: string): Promise<readonly SessionTimelineEvent[]>;

  listCompensationsByBookingId(bookingId: string): Promise<readonly SessionCompensationSummary[]>;
}
