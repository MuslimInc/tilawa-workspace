...
```text
Local file:
  apps/quran_image_flutter/assets/quran_images.zip
...
```text
Local file:
  apps/quran_image_flutter/assets/images/sura_header_banner.webp
...
apps/quran_image_flutter/tools/upload_quran_assets_to_r2.sh --dry-run
apps/quran_image_flutter/tools/upload_quran_assets_to_r2.sh
```

To publish a new immutable asset version:

```sh
R2_PREFIX=v2 apps/quran_image_flutter/tools/upload_quran_assets_to_r2.sh
```
