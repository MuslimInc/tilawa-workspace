  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        // Grid tiles can be shorter than list rows; keep a single text line

        // when vertical space is near the 48px avatar height.

        final bool isTight = constraints.maxHeight < 48 + tokens.spaceSmall;
        ...
        return Column(
          ...
          children: [
            ...
            if (!isTight && moshafLabel != null) ...[
              SizedBox(height: tokens.spaceExtraSmall),

              _MoshafMetadataRow(label: moshafLabel),
            ] else if (!isTight && moshafCount == 0) ...[
              SizedBox(height: tokens.spaceExtraSmall),
            ...
            ] else if (isTight && moshafLabel != null) ...[
              SizedBox(height: tokens.spaceExtraSmall),
