...
@lazySingleton
class IncrementTasbeehCountUseCase implements UseCase<TasbeehDhikr, String> {
  IncrementTasbeehCountUseCase(this._repository);

  final TasbeehRepository _repository;

  @override
  Future<Either<Failure, TasbeehDhikr>> call(String params) {
    return _repository.incrementCount(params);
  }
}
