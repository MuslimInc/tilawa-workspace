...
class RGBWithRedColorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Gradient gradientH = LinearGradient(
      colors: [
        Color.fromRGBO((color.r * 255).round(), 255, 0, 1.0),
        Color.fromRGBO((color.r * 255).round(), 255, 255, 1.0),
      ],
    );
    final Gradient gradientV = LinearGradient(
      ...
      colors: [
        Color.fromRGBO((color.r * 255).round(), 255, 255, 1.0),
        Color.fromRGBO((color.r * 255).round(), 0, 255, 1.0),
      ],
    );
    canvas.drawRect(rect, Paint()..shader = gradientH.createShader(rect));
    canvas.drawRect(
    ...
    canvas.drawCircle(
      Offset(
        size.width * (color.b * 255).round() / 255,
        size.height * (1 - (color.g * 255).round() / 255),
      ),
      size.height * 0.04,
      Paint()
        ..color =
...
class RGBWithGreenColorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Gradient gradientH = LinearGradient(
      colors: [
        Color.fromRGBO(255, (color.g * 255).round(), 0, 1.0),
        Color.fromRGBO(255, (color.g * 255).round(), 255, 1.0),
      ],
    );
    final Gradient gradientV = LinearGradient(
      begin: Alignment.topCenter,
      ...
      colors: [
        Color.fromRGBO(255, (color.g * 255).round(), 255, 1.0),
        Color.fromRGBO(0, (color.g * 255).round(), 255, 1.0),
      ],
    );
    canvas.drawRect(rect, Paint()..shader = gradientH.createShader(rect));
    canvas.drawRect(
    ...
    canvas.drawCircle(
      Offset(
        size.width * (color.b * 255).round() / 255,
        size.height * (1 - (color.r * 255).round() / 255),
      ),
      size.height * 0.04,
      Paint()
        ..color =
...
class RGBWithBlueColorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Gradient gradientH = LinearGradient(
      colors: [
        Color.fromRGBO(0, 255, (color.b * 255).round(), 1.0),
        Color.fromRGBO(255, 255, (color.b * 255).round(), 1.0),
      ],
    );
    final Gradient gradientV = LinearGradient(
      begin: Alignment.topCenter,
      ...
      colors: [
        Color.fromRGBO(255, 255, (color.b * 255).round(), 1.0),
        Color.fromRGBO(255, 0, (color.b * 255).round(), 1.0),
      ],
    );
    canvas.drawRect(rect, Paint()..shader = gradientH.createShader(rect));
    canvas.drawRect(
    ...
    canvas.drawCircle(
      Offset(
        size.width * (color.r * 255).round() / 255,
        size.height * (1 - (color.g * 255).round() / 255),
      ),
      size.height * 0.04,
      Paint()
...
class HUEColorWheelPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final double radio = size.width <= size.height
        ? size.width / 2
        : size.height / 2;
...
class IndicatorPainter extends CustomPainter {
  ...
  @override
  void paint(Canvas canvas, Size size) {
    final chessSize = Size(size.width / 10, size.height / 10);
    final chessPaintB = Paint()..color = const Color(0xFFCCCCCC);
    final chessPaintW = Paint()..color = Colors.white;
    List.generate((size.height / chessSize.height).round(), (int y) {
      List.generate((size.width / chessSize.width).round(), (int x) {
...
class _ColorPickerLabelState extends State<ColorPickerLabel> {
  ...
  List<String> colorValue(HSVColor hsvColor, ColorLabelType colorLabelType) {
    if (colorLabelType == ColorLabelType.hex) {
      ...
      return [
        (color.r * 255).round().toRadixString(16).toUpperCase().padLeft(2, '0'),
        (color.g * 255).round().toRadixString(16).toUpperCase().padLeft(2, '0'),
        (color.b * 255).round().toRadixString(16).toUpperCase().padLeft(2, '0'),
        (color.a * 255).round().toRadixString(16).toUpperCase().padLeft(2, '0'),
      ];
...
class ColorPickerSlider extends StatelessWidget {
  ...
  void slideEvent(RenderBox getBox, BoxConstraints box, Offset globalPosition) {
    ...
    switch (trackType) {
      ...
      case TrackType.red:
        onColorChanged(
          HSVColor.fromColor(hsvColor.toColor().withValues(red: progress)),
        );
      case TrackType.green:
        onColorChanged(
          HSVColor.fromColor(hsvColor.toColor().withValues(green: progress)),
        );
      case TrackType.blue:
        onColorChanged(
          HSVColor.fromColor(hsvColor.toColor().withValues(blue: progress)),
        );
      case TrackType.alpha:
        onColorChanged(
          hsvColor.withAlpha(
...
class ColorPickerArea extends StatelessWidget {
  ...
  void _handleColorRectChange(double horizontal, double vertical) {
    switch (paletteType) {
      ...
      case PaletteType.rgbWithRed:
        onColorChanged(
          HSVColor.fromColor(
            hsvColor.toColor().withValues(blue: horizontal, green: vertical),
          ),
        );
      case PaletteType.rgbWithGreen:
        onColorChanged(
          HSVColor.fromColor(
            hsvColor.toColor().withValues(blue: horizontal, red: vertical),
          ),
        );
      case PaletteType.rgbWithBlue:
        onColorChanged(
          HSVColor.fromColor(
            hsvColor.toColor().withValues(red: horizontal, green: vertical),
          ),
        );
  ...
  void _handleGesture(
    ...
    if (paletteType == PaletteType.hueWheel) {
      ...
      final double radio = width <= height ? width / 2 : height / 2;
      final double dist =
