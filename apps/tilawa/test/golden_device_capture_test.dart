...
void main() {
  group('Quran Pixel Validation Capture', () {
    ...
    for (final device in devices.entries) {
      testWidgets('Capture Quran Page 207 on ${device.key}', (WidgetTester tester) async {
        ...
        await expectLater(
          ...
          matchesGoldenFile('../../../screenshots/tilawa_page_207_${device.key}.png'),
        );
