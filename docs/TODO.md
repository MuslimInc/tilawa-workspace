...
- [x] **Android — Impeller (Flutter default)**
  No `EnableImpeller` override in
  [`AndroidManifest.xml`](../apps/tilawa/android/app/src/main/AndroidManifest.xml).
  See [`quran_reader_architecture.md`](quran_reader_architecture.md#android-rendering-backend).
