...
test("resolveSessionConfigWarnings returns no warnings for valid context", () => {
  const context = {
    marketEnabled: true,
    pricing: { isPaid: true },
    market: { paymentProviderEnabled: true, manualPaymentEnabled: false, teacherWhitelist: null },
...
test("resolveSessionConfigWarnings returns paid_but_payment_disabled", () => {
  const context = {
    marketEnabled: true,
    pricing: { isPaid: true },
    market: { paymentProviderEnabled: false, manualPaymentEnabled: false, teacherWhitelist: null },
    teacher: { id: "t1", exists: true, verificationStatus: "verified" },
    student: { exists: true, accountStatus: "active" },
  };
  const warnings = resolveSessionConfigWarnings(context);
...
test("resolveSessionConfigWarnings accepts manual paid market", () => {
  const context = {
    marketEnabled: true,
    pricing: { isPaid: true },
    market: { paymentProviderEnabled: false, manualPaymentEnabled: true, teacherWhitelist: null },
    teacher: { id: "t1", exists: true, verificationStatus: "verified" },
    student: { exists: true, accountStatus: "active" },
  };
  const warnings = resolveSessionConfigWarnings(context);
...
test("resolveSessionConfigWarnings returns teacher_not_whitelisted", () => {
  const context = {
    marketEnabled: true,
    pricing: { isPaid: true },
    market: { paymentProviderEnabled: true, manualPaymentEnabled: false, teacherWhitelist: ["t2", "t3"] },
    teacher: { id: "t1", exists: true, verificationStatus: "verified" },
    student: { exists: true, accountStatus: "active" },
  };
  const warnings = resolveSessionConfigWarnings(context);
