 ...
 * no per-call Firestore read. Default **off**; set
 * `MULTI_DEVICE_LOGIN_ENABLED=true` in the staging Functions environment.
 *
...
export function isMultiDeviceLoginEnabled(): boolean {
  return process.env.MULTI_DEVICE_LOGIN_ENABLED === "true";
}
