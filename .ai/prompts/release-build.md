...
2. **Build with the project command:**
   - Android production AAB: `melos run tilawa:build:android:production`
...
4. **Deploy only if explicitly authorized.** State the exact command you would
