...
$MosahfCopyWith<Mosahf> get copyWith => _$MosahfCopyWithImpl<Mosahf>(this as Mosahf, _$identity);
...
abstract mixin class $MosahfCopyWith<$Res>  {
  factory $MosahfCopyWith(Mosahf value, $Res Function(Mosahf) _then) = _$MosahfCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$MosahfCopyWithImpl<$Res>
    implements $MosahfCopyWith<$Res> {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Mosahf value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Mosahf value)  $default,){
final _that = this;
switch (_that) {
case _Mosahf():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Mosahf value)?  $default,){
final _that = this;
switch (_that) {
case _Mosahf() when $default != null:
return $default(_that);case _:
...
class _Mosahf implements Mosahf {
  const _Mosahf({required this.id, required this.name, required this.server, @JsonKey(name: 'surah_total') required this.surahTotal, @JsonKey(name: 'moshaf_type') required this.moshafType, @JsonKey(name: 'surah_list') required this.surahList});
...
@pragma('vm:prefer-inline')
_$MosahfCopyWith<_Mosahf> get copyWith => __$MosahfCopyWithImpl<_Mosahf>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Mosahf&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.server, server) || other.server == server)&&(identical(other.surahTotal, surahTotal) || other.surahTotal == surahTotal)&&(identical(other.moshafType, moshafType) || other.moshafType == moshafType)&&(identical(other.surahList, surahList) || other.surahList == surahList));
}
...
abstract mixin class _$MosahfCopyWith<$Res> implements $MosahfCopyWith<$Res> {
  factory _$MosahfCopyWith(_Mosahf value, $Res Function(_Mosahf) _then) = __$MosahfCopyWithImpl;
@override @useResult
$Res call({
 int id, String name, String server,@JsonKey(name: 'surah_total') int surahTotal,@JsonKey(name: 'moshaf_type') int moshafType,@JsonKey(name: 'surah_list') String surahList
});
...
/// @nodoc
class __$MosahfCopyWithImpl<$Res>
    implements _$MosahfCopyWith<$Res> {
...
mixin _$Reciter {
 ...
 int get id; String get name; String get letter; String get date; List<Mosahf> get moshaf;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Reciter&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.letter, letter) || other.letter == letter)&&(identical(other.date, date) || other.date == date)&&const DeepCollectionEquality().equals(other.moshaf, moshaf));
}
...
@useResult
$Res call({
 int id, String name, String letter, String date, List<Mosahf> moshaf
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Reciter value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Reciter value)  $default,){
final _that = this;
switch (_that) {
case _Reciter():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Reciter value)?  $default,){
final _that = this;
switch (_that) {
case _Reciter() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  String letter,  String date,  List<Mosahf> moshaf)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Reciter() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  String letter,  String date,  List<Mosahf> moshaf)  $default,) {final _that = this;
switch (_that) {
case _Reciter():
return $default(_that.id,_that.name,_that.letter,_that.date,_that.moshaf);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  String letter,  String date,  List<Mosahf> moshaf)?  $default,) {final _that = this;
switch (_that) {
case _Reciter() when $default != null:
return $default(_that.id,_that.name,_that.letter,_that.date,_that.moshaf);case _:
  return null;
...
class _Reciter implements Reciter {
  const _Reciter({required this.id, required this.name, required this.letter, required this.date, required final  List<Mosahf> moshaf}): _moshaf = moshaf;
...
@override List<Mosahf> get moshaf {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$RecitersModelCopyWith<RecitersModel> get copyWith => _$RecitersModelCopyWithImpl<RecitersModel>(this as RecitersModel, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RecitersModel&&const DeepCollectionEquality().equals(other.reciters, reciters));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(reciters));
...
abstract mixin class $RecitersModelCopyWith<$Res>  {
  factory $RecitersModelCopyWith(RecitersModel value, $Res Function(RecitersModel) _then) = _$RecitersModelCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of RecitersModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? reciters = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RecitersModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RecitersModel value)  $default,){
final _that = this;
switch (_that) {
case _RecitersModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RecitersModel value)?  $default,){
final _that = this;
switch (_that) {
case _RecitersModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Reciter> reciters)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RecitersModel() when $default != null:
return $default(_that.reciters);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Reciter> reciters)  $default,) {final _that = this;
switch (_that) {
case _RecitersModel():
return $default(_that.reciters);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Reciter> reciters)?  $default,) {final _that = this;
switch (_that) {
case _RecitersModel() when $default != null:
return $default(_that.reciters);case _:
  return null;
...
class _RecitersModel implements RecitersModel {
  const _RecitersModel({required final  List<Reciter> reciters}): _reciters = reciters;
  factory _RecitersModel.fromJson(Map<String, dynamic> json) => _$RecitersModelFromJson(json);

 final  List<Reciter> _reciters;
@override List<Reciter> get reciters {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$RecitersModelCopyWith<_RecitersModel> get copyWith => __$RecitersModelCopyWithImpl<_RecitersModel>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RecitersModel&&const DeepCollectionEquality().equals(other._reciters, _reciters));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_reciters));
...
/// @nodoc
abstract mixin class _$RecitersModelCopyWith<$Res> implements $RecitersModelCopyWith<$Res> {
  factory _$RecitersModelCopyWith(_RecitersModel value, $Res Function(_RecitersModel) _then) = __$RecitersModelCopyWithImpl;
@override @useResult
$Res call({
 List<Reciter> reciters
});
...
/// Create a copy of RecitersModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? reciters = null,}) {
  return _then(_RecitersModel(
