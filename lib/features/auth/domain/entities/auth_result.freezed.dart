...
AuthResult _$AuthResultFromJson(
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( AuthSuccess value)?  success,TResult Function( AuthFailure value)?  failure,TResult Function( AuthCancelled value)?  cancelled,required TResult orElse(),}){
final _that = this;
switch (_that) {
case AuthSuccess() when success != null:
return success(_that);case AuthFailure() when failure != null:
return failure(_that);case AuthCancelled() when cancelled != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( AuthSuccess value)  success,required TResult Function( AuthFailure value)  failure,required TResult Function( AuthCancelled value)  cancelled,}){
final _that = this;
switch (_that) {
case AuthSuccess():
return success(_that);case AuthFailure():
return failure(_that);case AuthCancelled():
return cancelled(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( AuthSuccess value)?  success,TResult? Function( AuthFailure value)?  failure,TResult? Function( AuthCancelled value)?  cancelled,}){
final _that = this;
switch (_that) {
case AuthSuccess() when success != null:
return success(_that);case AuthFailure() when failure != null:
...
return failure(_that.message,_that.code);case AuthCancelled() when cancelled != null:
...
return failure(_that.message,_that.code);case AuthCancelled():
return cancelled();case _:
  throw StateError('Unexpected subclass');
...
class AuthFailure implements AuthResult {
  const AuthFailure({required this.message, this.code, final  String? $type}): $type = $type ?? 'failure';
