...
mixin _$AthkarCategoryModel {
  ...
  $AthkarCategoryModelCopyWith<AthkarCategoryModel> get copyWith =>
      _$AthkarCategoryModelCopyWithImpl<AthkarCategoryModel>(
        this as AthkarCategoryModel,
        _$identity,
      );
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, super.hashCode, id, nameAr, nameEn, icon);
}

/// @nodoc
abstract mixin class $AthkarCategoryModelCopyWith<$Res> {
  factory $AthkarCategoryModelCopyWith(
    AthkarCategoryModel value,
    $Res Function(AthkarCategoryModel) _then,
  ) = _$AthkarCategoryModelCopyWithImpl;
  @useResult
  $Res call({
    int id,
...
extension AthkarCategoryModelPatterns on AthkarCategoryModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AthkarCategoryModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _AthkarCategoryModel() when $default != null:
        return $default(_that.id, _that.nameAr, _that.nameEn, _that.icon);
      case _:
        return orElse();
    }
  }
...
class _AthkarCategoryModel extends AthkarCategoryModel {
  const _AthkarCategoryModel({
    required this.id,
    @JsonKey(name: 'name_ar') required this.nameAr,
    @JsonKey(name: 'name_en') required this.nameEn,
    required this.icon,
  }) : super._();
  factory _AthkarCategoryModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AthkarCategoryModelCopyWith<_AthkarCategoryModel> get copyWith =>
      __$AthkarCategoryModelCopyWithImpl<_AthkarCategoryModel>(
        this,
        _$identity,
      );
...
/// @nodoc
abstract mixin class _$AthkarCategoryModelCopyWith<$Res>
    implements $AthkarCategoryModelCopyWith<$Res> {
  factory _$AthkarCategoryModelCopyWith(
    _AthkarCategoryModel value,
    $Res Function(_AthkarCategoryModel) _then,
  ) = __$AthkarCategoryModelCopyWithImpl;
  @override
  @useResult
  $Res call({
    int id,
