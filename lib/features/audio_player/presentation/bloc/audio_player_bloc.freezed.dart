...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( LoadAudioPlayerData value)?  loadAudioPlayerData,TResult Function( UpdateAudio value)?  updateAudio,TResult Function( UpdatePlaybackStateEntity value)?  updatePlaybackStateEntity,TResult Function( UpdatePositionData value)?  updatePositionData,TResult Function( UpdateVolume value)?  updateVolume,TResult Function( UpdateSpeed value)?  updateSpeed,TResult Function( PlayAudio value)?  playAudio,TResult Function( PauseAudio value)?  pauseAudio,TResult Function( StopAudio value)?  stopAudio,TResult Function( SkipToNext value)?  skipToNext,TResult Function( SkipToPrevious value)?  skipToPrevious,TResult Function( SeekTo value)?  seekTo,TResult Function( SetVolume value)?  setVolume,TResult Function( SetSpeed value)?  setSpeed,TResult Function( SkipToQueueItem value)?  skipToQueueItem,TResult Function( PlayFromQueue value)?  playFromQueue,TResult Function( UpdateQueue value)?  updateQueue,TResult Function( AddQueueItem value)?  addQueueItem,TResult Function( RemoveQueueItem value)?  removeQueueItem,TResult Function( MoveQueueItem value)?  moveQueueItem,TResult Function( SetRepeatMode value)?  setRepeatMode,TResult Function( SetShuffleMode value)?  setShuffleMode,TResult Function( SetSleepTimer value)?  setSleepTimer,TResult Function( CancelSleepTimer value)?  cancelSleepTimer,TResult Function( AudioTimerExpired value)?  audioTimerExpired,required TResult orElse(),}){
final _that = this;
switch (_that) {
case LoadAudioPlayerData() when loadAudioPlayerData != null:
return loadAudioPlayerData(_that);case UpdateAudio() when updateAudio != null:
return updateAudio(_that);case UpdatePlaybackStateEntity() when updatePlaybackStateEntity != null:
return updatePlaybackStateEntity(_that);case UpdatePositionData() when updatePositionData != null:
return updatePositionData(_that);case UpdateVolume() when updateVolume != null:
...
return setShuffleMode(_that);case SetSleepTimer() when setSleepTimer != null:
return setSleepTimer(_that);case CancelSleepTimer() when cancelSleepTimer != null:
return cancelSleepTimer(_that);case AudioTimerExpired() when audioTimerExpired != null:
return audioTimerExpired(_that);case _:
  return orElse();
...
return setShuffleMode(_that);case SetSleepTimer():
return setSleepTimer(_that);case CancelSleepTimer():
return cancelSleepTimer(_that);case AudioTimerExpired():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( LoadAudioPlayerData value)?  loadAudioPlayerData,TResult? Function( UpdateAudio value)?  updateAudio,TResult? Function( UpdatePlaybackStateEntity value)?  updatePlaybackStateEntity,TResult? Function( UpdatePositionData value)?  updatePositionData,TResult? Function( UpdateVolume value)?  updateVolume,TResult? Function( UpdateSpeed value)?  updateSpeed,TResult? Function( PlayAudio value)?  playAudio,TResult? Function( PauseAudio value)?  pauseAudio,TResult? Function( StopAudio value)?  stopAudio,TResult? Function( SkipToNext value)?  skipToNext,TResult? Function( SkipToPrevious value)?  skipToPrevious,TResult? Function( SeekTo value)?  seekTo,TResult? Function( SetVolume value)?  setVolume,TResult? Function( SetSpeed value)?  setSpeed,TResult? Function( SkipToQueueItem value)?  skipToQueueItem,TResult? Function( PlayFromQueue value)?  playFromQueue,TResult? Function( UpdateQueue value)?  updateQueue,TResult? Function( AddQueueItem value)?  addQueueItem,TResult? Function( RemoveQueueItem value)?  removeQueueItem,TResult? Function( MoveQueueItem value)?  moveQueueItem,TResult? Function( SetRepeatMode value)?  setRepeatMode,TResult? Function( SetShuffleMode value)?  setShuffleMode,TResult? Function( SetSleepTimer value)?  setSleepTimer,TResult? Function( CancelSleepTimer value)?  cancelSleepTimer,TResult? Function( AudioTimerExpired value)?  audioTimerExpired,}){
final _that = this;
switch (_that) {
case LoadAudioPlayerData() when loadAudioPlayerData != null:
return loadAudioPlayerData(_that);case UpdateAudio() when updateAudio != null:
...
return updateAudio(_that.audio);case UpdatePlaybackStateEntity() when updatePlaybackStateEntity != null:
return updatePlaybackStateEntity(_that.playbackState);case UpdatePositionData() when updatePositionData != null:
return updatePositionData(_that.positionData);case UpdateVolume() when updateVolume != null:
...
return addQueueItem(_that.audio);case RemoveQueueItem() when removeQueueItem != null:
return removeQueueItem(_that.audio);case MoveQueueItem() when moveQueueItem != null:
...
return updateAudio(_that.audio);case UpdatePlaybackStateEntity():
return updatePlaybackStateEntity(_that.playbackState);case UpdatePositionData():
return updatePositionData(_that.positionData);case UpdateVolume():
...
return addQueueItem(_that.audio);case RemoveQueueItem():
return removeQueueItem(_that.audio);case MoveQueueItem():
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UpdateAudioCopyWith<UpdateAudio> get copyWith => _$UpdateAudioCopyWithImpl<UpdateAudio>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateAudio&&(identical(other.audio, audio) || other.audio == audio));
}
...
/// @nodoc
abstract mixin class $UpdateAudioCopyWith<$Res> implements $AudioPlayerEventCopyWith<$Res> {
  factory $UpdateAudioCopyWith(UpdateAudio value, $Res Function(UpdateAudio) _then) = _$UpdateAudioCopyWithImpl;
@useResult
$Res call({
 AudioEntity? audio
});
...
/// @nodoc
class _$UpdateAudioCopyWithImpl<$Res>
    implements $UpdateAudioCopyWith<$Res> {
...
/// Create a copy of AudioPlayerEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? audio = freezed,}) {
  return _then(UpdateAudio(
freezed == audio ? _self.audio : audio // ignore: cast_nullable_to_non_nullable
as AudioEntity?,
  ));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UpdatePlaybackStateEntityCopyWith<UpdatePlaybackStateEntity> get copyWith => _$UpdatePlaybackStateEntityCopyWithImpl<UpdatePlaybackStateEntity>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdatePlaybackStateEntity&&(identical(other.playbackState, playbackState) || other.playbackState == playbackState));
}
...
/// @nodoc
abstract mixin class $UpdatePlaybackStateEntityCopyWith<$Res> implements $AudioPlayerEventCopyWith<$Res> {
  factory $UpdatePlaybackStateEntityCopyWith(UpdatePlaybackStateEntity value, $Res Function(UpdatePlaybackStateEntity) _then) = _$UpdatePlaybackStateEntityCopyWithImpl;
@useResult
$Res call({
...
@pragma('vm:prefer-inline') $Res call({Object? playbackState = null,}) {
  return _then(UpdatePlaybackStateEntity(
...
class PlayFromQueue implements AudioPlayerEvent {
  const PlayFromQueue(final  List<AudioEntity> queue, this.index): _queue = queue;
...
@useResult
$Res call({
 List<AudioEntity> queue, int index
});
...
as List<AudioEntity>,null == index ? _self.index : index // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddQueueItem&&(identical(other.audio, audio) || other.audio == audio));
}
...
null == audio ? _self.audio : audio // ignore: cast_nullable_to_non_nullable
as AudioEntity,
  ));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RemoveQueueItem&&(identical(other.audio, audio) || other.audio == audio));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SetSleepTimerCopyWith<SetSleepTimer> get copyWith => _$SetSleepTimerCopyWithImpl<SetSleepTimer>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SetSleepTimer&&(identical(other.duration, duration) || other.duration == duration));
}
...
/// @nodoc
abstract mixin class $SetSleepTimerCopyWith<$Res> implements $AudioPlayerEventCopyWith<$Res> {
  factory $SetSleepTimerCopyWith(SetSleepTimer value, $Res Function(SetSleepTimer) _then) = _$SetSleepTimerCopyWithImpl;
@useResult
$Res call({
 Duration duration
});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AudioTimerExpired);
}
...
mixin _$AudioPlayerState {
 ...
 AudioEntity? get currentAudio; PlaybackStateEntity? get playbackState; PositionData? get positionData; double get volume; double get speed; AudioRepeatMode get repeatMode; AudioShuffleMode get shuffleMode; DateTime? get sleepTimerTargetTime; Duration? get lastSleepTimerDuration; AudioPlayerStatus get status;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AudioPlayerState&&(identical(other.currentAudio, currentAudio) || other.currentAudio == currentAudio)&&(identical(other.playbackState, playbackState) || other.playbackState == playbackState)&&(identical(other.positionData, positionData) || other.positionData == positionData)&&(identical(other.volume, volume) || other.volume == volume)&&(identical(other.speed, speed) || other.speed == speed)&&(identical(other.repeatMode, repeatMode) || other.repeatMode == repeatMode)&&(identical(other.shuffleMode, shuffleMode) || other.shuffleMode == shuffleMode)&&(identical(other.sleepTimerTargetTime, sleepTimerTargetTime) || other.sleepTimerTargetTime == sleepTimerTargetTime)&&(identical(other.lastSleepTimerDuration, lastSleepTimerDuration) || other.lastSleepTimerDuration == lastSleepTimerDuration)&&(identical(other.status, status) || other.status == status));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,currentAudio,playbackState,positionData,volume,speed,repeatMode,shuffleMode,sleepTimerTargetTime,lastSleepTimerDuration,status);
...
@useResult
$Res call({
 AudioEntity? currentAudio, PlaybackStateEntity? playbackState, PositionData? positionData, double volume, double speed, AudioRepeatMode repeatMode, AudioShuffleMode shuffleMode, DateTime? sleepTimerTargetTime, Duration? lastSleepTimerDuration, AudioPlayerStatus status
});


$AudioEntityCopyWith<$Res>? get currentAudio;$PlaybackStateEntityCopyWith<$Res>? get playbackState;$PositionDataCopyWith<$Res>? get positionData;
...
/// Create a copy of AudioPlayerState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentAudio = freezed,Object? playbackState = freezed,Object? positionData = freezed,Object? volume = null,Object? speed = null,Object? repeatMode = null,Object? shuffleMode = null,Object? sleepTimerTargetTime = freezed,Object? lastSleepTimerDuration = freezed,Object? status = null,}) {
  return _then(_self.copyWith(
currentAudio: freezed == currentAudio ? _self.currentAudio : currentAudio // ignore: cast_nullable_to_non_nullable
as AudioEntity?,playbackState: freezed == playbackState ? _self.playbackState : playbackState // ignore: cast_nullable_to_non_nullable
as PlaybackStateEntity?,positionData: freezed == positionData ? _self.positionData : positionData // ignore: cast_nullable_to_non_nullable
as PositionData?,volume: null == volume ? _self.volume : volume // ignore: cast_nullable_to_non_nullable
...
as AudioRepeatMode,shuffleMode: null == shuffleMode ? _self.shuffleMode : shuffleMode // ignore: cast_nullable_to_non_nullable
as AudioShuffleMode,sleepTimerTargetTime: freezed == sleepTimerTargetTime ? _self.sleepTimerTargetTime : sleepTimerTargetTime // ignore: cast_nullable_to_non_nullable
as DateTime?,lastSleepTimerDuration: freezed == lastSleepTimerDuration ? _self.lastSleepTimerDuration : lastSleepTimerDuration // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( AudioEntity? currentAudio,  PlaybackStateEntity? playbackState,  PositionData? positionData,  double volume,  double speed,  AudioRepeatMode repeatMode,  AudioShuffleMode shuffleMode,  DateTime? sleepTimerTargetTime,  Duration? lastSleepTimerDuration,  AudioPlayerStatus status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AudioPlayerState() when $default != null:
return $default(_that.currentAudio,_that.playbackState,_that.positionData,_that.volume,_that.speed,_that.repeatMode,_that.shuffleMode,_that.sleepTimerTargetTime,_that.lastSleepTimerDuration,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AudioEntity? currentAudio,  PlaybackStateEntity? playbackState,  PositionData? positionData,  double volume,  double speed,  AudioRepeatMode repeatMode,  AudioShuffleMode shuffleMode,  DateTime? sleepTimerTargetTime,  Duration? lastSleepTimerDuration,  AudioPlayerStatus status)  $default,) {final _that = this;
switch (_that) {
case _AudioPlayerState():
return $default(_that.currentAudio,_that.playbackState,_that.positionData,_that.volume,_that.speed,_that.repeatMode,_that.shuffleMode,_that.sleepTimerTargetTime,_that.lastSleepTimerDuration,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( AudioEntity? currentAudio,  PlaybackStateEntity? playbackState,  PositionData? positionData,  double volume,  double speed,  AudioRepeatMode repeatMode,  AudioShuffleMode shuffleMode,  DateTime? sleepTimerTargetTime,  Duration? lastSleepTimerDuration,  AudioPlayerStatus status)?  $default,) {final _that = this;
switch (_that) {
case _AudioPlayerState() when $default != null:
return $default(_that.currentAudio,_that.playbackState,_that.positionData,_that.volume,_that.speed,_that.repeatMode,_that.shuffleMode,_that.sleepTimerTargetTime,_that.lastSleepTimerDuration,_that.status);case _:
  return null;
...
class _AudioPlayerState extends AudioPlayerState {
  const _AudioPlayerState({this.currentAudio, this.playbackState, this.positionData, this.volume = 1.0, this.speed = 1.0, this.repeatMode = AudioRepeatMode.none, this.shuffleMode = AudioShuffleMode.none, this.sleepTimerTargetTime, this.lastSleepTimerDuration, required this.status}): super._();
  factory _AudioPlayerState.fromJson(Map<String, dynamic> json) => _$AudioPlayerStateFromJson(json);

@override final  AudioEntity? currentAudio;
@override final  PlaybackStateEntity? playbackState;
@override final  PositionData? positionData;
@override@JsonKey() final  double volume;
@override@JsonKey() final  double speed;
@override@JsonKey() final  AudioRepeatMode repeatMode;
@override@JsonKey() final  AudioShuffleMode shuffleMode;
@override final  DateTime? sleepTimerTargetTime;
@override final  Duration? lastSleepTimerDuration;
...
@override $AudioEntityCopyWith<$Res>? get currentAudio;@override $PlaybackStateEntityCopyWith<$Res>? get playbackState;@override $PositionDataCopyWith<$Res>? get positionData;
...
/// Create a copy of AudioPlayerState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? currentAudio = freezed,Object? playbackState = freezed,Object? positionData = freezed,Object? volume = null,Object? speed = null,Object? repeatMode = null,Object? shuffleMode = null,Object? sleepTimerTargetTime = freezed,Object? lastSleepTimerDuration = freezed,Object? status = null,}) {
