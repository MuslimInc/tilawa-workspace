...
mixin _$DownloadButtonEvent {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is DownloadButtonEvent);
  }
...
class $DownloadButtonEventCopyWith<$Res> {
  $DownloadButtonEventCopyWith(
    DownloadButtonEvent _,
    $Res Function(DownloadButtonEvent) __,
  );
}
...
extension DownloadButtonEventPatterns on DownloadButtonEvent {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    TResult Function(_PendingDetected value)? pendingDetected,
    ...
    switch (_that) {
      ...
      case _StartDownload() when startDownload != null:
        return startDownload(_that);
      case _Cancel() when cancel != null:
        return cancel(_that);
      case _ProgressUpdated() when progressUpdated != null:
        return progressUpdated(_that);
      ...
      case _Paused() when paused != null:
        return paused(_that);
      case _PendingDetected() when pendingDetected != null:
        return pendingDetected(_that);
      case _:
        return orElse();
    }
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(_PendingDetected value) pendingDetected,
  }) {
    final _that = this;
    switch (_that) {
      case _Initialize():
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(String surahTitle)? startDownload,
    TResult Function()? cancel,
    TResult Function(double progress, int downloadedBytes, int totalBytes)?
    progressUpdated,
    TResult Function()? completed,
    TResult Function(String? errorMessage)? failed,
    TResult Function()? cancelled,
    TResult Function()? paused,
    TResult Function()? pendingDetected,
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Initialize() when initialize != null:
        return initialize();
      case _StartDownload() when startDownload != null:
        return startDownload(_that.surahTitle);
      case _Cancel() when cancel != null:
        return cancel();
      case _ProgressUpdated() when progressUpdated != null:
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String surahTitle) startDownload,
    ...
    required TResult Function() pendingDetected,
  }) {
    final _that = this;
    switch (_that) {
      case _Initialize():
...
/// @nodoc
abstract mixin class _$StartDownloadCopyWith<$Res>
    implements $DownloadButtonEventCopyWith<$Res> {
  factory _$StartDownloadCopyWith(
    _StartDownload value,
    $Res Function(_StartDownload) _then,
  ) = __$StartDownloadCopyWithImpl;
  @useResult
  $Res call({String surahTitle});
}
...
class __$StartDownloadCopyWithImpl<$Res>
  ...
  /// with the given fields replaced by the non-null parameter values.
  @pragma('vm:prefer-inline')
  $Res call({Object? surahTitle = null}) {
    return _then(
      _StartDownload(
...
class _ProgressUpdated implements DownloadButtonEvent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ProgressUpdatedCopyWith<_ProgressUpdated> get copyWith =>
      __$ProgressUpdatedCopyWithImpl<_ProgressUpdated>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ProgressUpdated &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, progress, downloadedBytes, totalBytes);
...
/// @nodoc
abstract mixin class _$ProgressUpdatedCopyWith<$Res>
    implements $DownloadButtonEventCopyWith<$Res> {
  factory _$ProgressUpdatedCopyWith(
    _ProgressUpdated value,
    $Res Function(_ProgressUpdated) _then,
  ) = __$ProgressUpdatedCopyWithImpl;
  @useResult
  $Res call({double progress, int downloadedBytes, int totalBytes});
}
...
class _PendingDetected implements DownloadButtonEvent {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _PendingDetected);
  }
...
mixin _$DownloadButtonState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is DownloadButtonState);
  }
...
class $DownloadButtonStateCopyWith<$Res> {
  $DownloadButtonStateCopyWith(
    DownloadButtonState _,
    $Res Function(DownloadButtonState) __,
  );
}
...
extension DownloadButtonStatePatterns on DownloadButtonState {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    TResult Function(_PendingState value)? pending,
    ...
    TResult Function(_PausedState value)? paused,
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      ...
      case _ReadyToDownload() when readyToDownload != null:
        return readyToDownload(_that);
      case _PendingState() when pending != null:
        return pending(_that);
      case _Downloading() when downloading != null:
        return downloading(_that);
      case _CompletedState() when completed != null:
        return completed(_that);
      case _FailedState() when failed != null:
        return failed(_that);
      case _CancelledState() when cancelled != null:
        return cancelled(_that);
      case _NetworkError() when networkError != null:
        return networkError(_that);
      case _PausedState() when paused != null:
        return paused(_that);
      case _:
        return orElse();
    }
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(_PendingState value) pending,
    ...
    required TResult Function(_PausedState value) paused,
  }) {
    final _that = this;
    switch (_that) {
      case _Initial():
        return initial(_that);
      case _ReadyToDownload():
        return readyToDownload(_that);
      case _PendingState():
        return pending(_that);
      case _Downloading():
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case _CancelledState() when cancelled != null:
        return cancelled();
      case _NetworkError() when networkError != null:
        return networkError(_that.errorMessage);
      case _PausedState() when paused != null:
        return paused();
      case _:
        return orElse();
...
class _ReadyToDownload implements DownloadButtonState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _ReadyToDownload);
  }
...
class _PendingState implements DownloadButtonState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _PendingState);
  }
...
abstract mixin class _$DownloadingCopyWith<$Res>
    implements $DownloadButtonStateCopyWith<$Res> {
  factory _$DownloadingCopyWith(
    _Downloading value,
    $Res Function(_Downloading) _then,
...
class _CompletedState implements DownloadButtonState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _CompletedState);
  }
...
class _FailedState implements DownloadButtonState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FailedStateCopyWith<_FailedState> get copyWith =>
      __$FailedStateCopyWithImpl<_FailedState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FailedState &&
            (identical(other.errorMessage, errorMessage) ||
                other.errorMessage == errorMessage));
  }
...
/// @nodoc
abstract mixin class _$FailedStateCopyWith<$Res>
    implements $DownloadButtonStateCopyWith<$Res> {
  factory _$FailedStateCopyWith(
    _FailedState value,
    $Res Function(_FailedState) _then,
...
/// @nodoc
class __$FailedStateCopyWithImpl<$Res> implements _$FailedStateCopyWith<$Res> {
...
class _CancelledState implements DownloadButtonState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _CancelledState);
  }
...
abstract mixin class _$NetworkErrorCopyWith<$Res>
  ...
  factory _$NetworkErrorCopyWith(
    _NetworkError value,
    $Res Function(_NetworkError) _then,
...
class _PausedState implements DownloadButtonState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _PausedState);
  }
