...
mixin _$SubscriptionPlan {
 ...
 String get id; String get name; String get description; double get price; String get currency; SubscriptionType get type; int get durationInDays; List<String> get features; bool get isPopular; double? get discountPercentage; int get order;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SubscriptionPlan&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.price, price) || other.price == price)&&(identical(other.currency, currency) || other.currency == currency)&&(identical(other.type, type) || other.type == type)&&(identical(other.durationInDays, durationInDays) || other.durationInDays == durationInDays)&&const DeepCollectionEquality().equals(other.features, features)&&(identical(other.isPopular, isPopular) || other.isPopular == isPopular)&&(identical(other.discountPercentage, discountPercentage) || other.discountPercentage == discountPercentage)&&(identical(other.order, order) || other.order == order));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,price,currency,type,durationInDays,const DeepCollectionEquality().hash(features),isPopular,discountPercentage,order);
...
@useResult
$Res call({
 String id, String name, String description, double price, String currency, SubscriptionType type, int durationInDays, List<String> features, bool isPopular, double? discountPercentage, int order
});
...
/// Create a copy of SubscriptionPlan
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? description = null,Object? price = null,Object? currency = null,Object? type = null,Object? durationInDays = null,Object? features = null,Object? isPopular = null,Object? discountPercentage = freezed,Object? order = null,}) {
...
as SubscriptionType,durationInDays: null == durationInDays ? _self.durationInDays : durationInDays // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String description,  double price,  String currency,  SubscriptionType type,  int durationInDays,  List<String> features,  bool isPopular,  double? discountPercentage,  int order)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SubscriptionPlan() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.price,_that.currency,_that.type,_that.durationInDays,_that.features,_that.isPopular,_that.discountPercentage,_that.order);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String description,  double price,  String currency,  SubscriptionType type,  int durationInDays,  List<String> features,  bool isPopular,  double? discountPercentage,  int order)  $default,) {final _that = this;
switch (_that) {
case _SubscriptionPlan():
return $default(_that.id,_that.name,_that.description,_that.price,_that.currency,_that.type,_that.durationInDays,_that.features,_that.isPopular,_that.discountPercentage,_that.order);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String description,  double price,  String currency,  SubscriptionType type,  int durationInDays,  List<String> features,  bool isPopular,  double? discountPercentage,  int order)?  $default,) {final _that = this;
switch (_that) {
case _SubscriptionPlan() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.price,_that.currency,_that.type,_that.durationInDays,_that.features,_that.isPopular,_that.discountPercentage,_that.order);case _:
  return null;
...
class _SubscriptionPlan implements SubscriptionPlan {
  const _SubscriptionPlan({required this.id, required this.name, required this.description, required this.price, required this.currency, required this.type, required this.durationInDays, required final  List<String> features, required this.isPopular, required this.discountPercentage, this.order = 0}): _features = features;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SubscriptionPlan&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.price, price) || other.price == price)&&(identical(other.currency, currency) || other.currency == currency)&&(identical(other.type, type) || other.type == type)&&(identical(other.durationInDays, durationInDays) || other.durationInDays == durationInDays)&&const DeepCollectionEquality().equals(other._features, _features)&&(identical(other.isPopular, isPopular) || other.isPopular == isPopular)&&(identical(other.discountPercentage, discountPercentage) || other.discountPercentage == discountPercentage)&&(identical(other.order, order) || other.order == order));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,price,currency,type,durationInDays,const DeepCollectionEquality().hash(_features),isPopular,discountPercentage,order);
...
/// Create a copy of SubscriptionPlan
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? description = null,Object? price = null,Object? currency = null,Object? type = null,Object? durationInDays = null,Object? features = null,Object? isPopular = null,Object? discountPercentage = freezed,Object? order = null,}) {
